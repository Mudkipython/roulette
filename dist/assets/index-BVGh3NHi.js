...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $s(e,t,n){let r=new Float32Array(zs),i=new H(0,1,0);return new po({name:`SphericalGaussianBlur`,defines:{n:zs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:nc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ec(){return new po({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:nc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function tc(){return new po({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:nc(),fragmentShader:`
	...
	`}var rc=class extends Yt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Oi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Ol={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function kl(e,t){let n=Ol[t];return n===void 0?(R(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Al=new H;function jl(){return W.getLuminanceCoefficients(Al),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Al.x.toFixed(4)}, ${Al.y.toFixed(4)}, ${Al.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=bl(i,i.VERTEX_SHADER,y),S=bl(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=El(i,x,`vertex`),n=El(i,S,`fragment`);z(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Uu=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},Wu=new Zo(-1,1,1,-1,0,1),Gu=new class extends kr{constructor(){super(),this.setAttribute(`position`,new K([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new K([0,2,0,0,2,0],2))}},Ku=class{constructor(e){this._mesh=new q(Gu,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Wu)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},qu=class extends Uu{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof po?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=lo.clone(e.uniforms),this.material=new po({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Ku(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Ju=class extends Uu{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Yu=class extends Uu{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},Xu=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new V);this._width=n.width,this._height=n.height,t=new Yt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:v}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new qu(Hu),this.copyPass.material.blending=0,this.timer=new is}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}Ju!==void 0&&(r instanceof Ju?n=!0:r instanceof Yu&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new V);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Zu=class extends Uu{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new G}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Qu={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new G(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}_getCompositeMaterial(e){return new po({defines:{NUM_MIPS:e},uniforms:{blurTexture1:{value:null},blurTexture2:{value:null},blurTexture3:{value:null},blurTexture4:{value:null},blurTexture5:{value:null},bloomStrength:{value:1},bloomFactors:{value:null},bloomTintColors:{value:null},bloomRadius:{value:0}},vertexShader:`
				...
				}`})}};$u.BlurDirectionX=new V(1,0),$u.BlurDirectionY=new V(0,1);var ed={type:`change`},td={type:`start`},nd={type:`end`},rd=new ii,id=new Ci,ad=Math.cos(70*kt.DEG2RAD),od=new H,sd=2*Math.PI,cd={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},ld=1e-6,ud=class extends Cs{constructor(n,r=null){super(n,r),this.state=cd.NONE,this.target=new H,this.cursor=new H,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:`ArrowLeft`,UP:`ArrowUp`,RIGHT:`ArrowRight`,BOTTOM:`ArrowDown`},this.mouseButtons={LEFT:e.ROTATE,MIDDLE:e.DOLLY,RIGHT:e.PAN},this.touches={ONE:t.ROTATE,TWO:t.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle=`auto`,this._domElementKeyEvents=null,this._lastPosition=new H,this._lastQuaternion=new At,this._lastTargetPosition=new H,this._quat=new At().setFromUnitVectors(n.up,new H(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new Ss,this._sphericalDelta=new Ss,this._scale=1,this._panOffset=new H,this._rotateStart=new V,this._rotateEnd=new V,this._rotateDelta=new V,this._panStart=new V,this._panEnd=new V,this._panDelta=new V,this._dollyStart=new V,this._dollyEnd=new V,this._dollyDelta=new V,this._dollyDirection=new H,this._mouse=new V,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=fd.bind(this),this._onPointerDown=dd.bind(this),this._onPointerUp=pd.bind(this),this._onContextMenu=bd.bind(this),this._onMouseWheel=gd.bind(this),this._onKeyDown=_d.bind(this),this._onTouchStart=vd.bind(this),this._onTouchMove=yd.bind(this),this._onMouseDown=md.bind(this),this._onMouseMove=hd.bind(this),this._interceptControlDown=xd.bind(this),this._interceptControlUp=Sd.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e===`grab`?this.domElement.style.cursor=`grab`:this.domElement.style.cursor=`auto`}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener(`pointerdown`,this._onPointerDown),this.domElement.addEventListener(`pointercancel`,this._onPointerUp),this.domElement.addEventListener(`contextmenu`,this._onContextMenu),this.domElement.addEventListener(`wheel`,this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener(`keydown`,this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction=`none`}disconnect(){this.domElement.removeEventListener(`pointerdown`,this._onPointerDown),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.domElement.removeEventListener(`pointercancel`,this._onPointerUp),this.domElement.removeEventListener(`wheel`,this._onMouseWheel),this.domElement.removeEventListener(`contextmenu`,this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener(`keydown`,this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction=``}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(ed),this.update(),this.state=cd.NONE}pan(e,t){this._pan(e,t),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){let t=this.object.position;od.copy(t).sub(this.target),od.applyQuaternion(this._quat),this._spherical.setFromVector3(od),this.autoRotate&&this.state===cd.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(n)&&isFinite(r)&&(n<-Math.PI?n+=sd:n>Math.PI&&(n-=sd),r<-Math.PI?r+=sd:r>Math.PI&&(r-=sd),n<=r?this._spherical.theta=Math.max(n,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+r)/2?Math.max(n,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let i=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let e=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),i=e!=this._spherical.radius}if(od.setFromSpherical(this._spherical),od.applyQuaternion(this._quatInverse),t.copy(this.target).add(od),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let e=null;if(this.object.isPerspectiveCamera){let t=od.length();e=this._clampDistance(t*this._scale);let n=t-e;this.object.position.addScaledVector(this._dollyDirection,n),this.object.updateMatrixWorld(),i=!!n}else if(this.object.isOrthographicCamera){let t=new H(this._mouse.x,this._mouse.y,0);t.unproject(this.object);let n=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),i=n!==this.object.zoom;let r=new H(this._mouse.x,this._mouse.y,0);r.unproject(this.object),this.object.position.sub(r).add(t),this.object.updateMatrixWorld(),e=od.length()}else console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled.`),this.zoomToCursor=!1;e!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position):(rd.origin.copy(this.object.position),rd.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(rd.direction))<ad?this.object.lookAt(this.target):(id.setFromNormalAndCoplanarPoint(this.object.up,this.target),rd.intersectPlane(id,this.target))))}else if(this.object.isOrthographicCamera){let e=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),e!==this.object.zoom&&(this.object.updateProjectionMatrix(),i=!0)}return this._scale=1,this._performCursorZoom=!1,i||this._lastPosition.distanceToSquared(this.object.position)>ld||8*(1-this._lastQuaternion.dot(this.object.quaternion))>ld||this._lastTargetPosition.distanceToSquared(this.target)>ld?(this.dispatchEvent(ed),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e===null?sd/60/60*this.autoRotateSpeed:sd/60*this.autoRotateSpeed*e}_getZoomScale(e){let t=Math.abs(e*.01);return .95**(this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){od.setFromMatrixColumn(t,0),od.multiplyScalar(-e),this._panOffset.add(od)}_panUp(e,t){this.screenSpacePanning===!0?od.setFromMatrixColumn(t,1):(od.setFromMatrixColumn(t,0),od.crossVectors(this.object.up,od)),od.multiplyScalar(e),this._panOffset.add(od)}_pan(e,t){let n=this.domElement;if(this.object.isPerspectiveCamera){let r=this.object.position;od.copy(r).sub(this.target);let i=od.length();i*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*i/n.clientHeight,this.object.matrix),this._panUp(2*t*i/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.`),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let n=this.domElement.getBoundingClientRect(),r=e-n.left,i=t-n.top,a=n.width,o=n.height;this._mouse.x=r/a*2-1,this._mouse.y=-(i/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(sd*this._rotateDelta.x/t.clientHeight),this._rotateUp(sd*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(sd*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-sd*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(sd*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-sd*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0;break}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateStart.set(n,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panStart.set(n,r)}}_handleTouchStartDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyStart.set(0,i)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateEnd.set(n,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(sd*this._rotateDelta.x/t.clientHeight),this._rotateUp(sd*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panEnd.set(n,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyEnd.set(0,i),this._dollyDelta.set(0,(this._dollyEnd.y/this._dollyStart.y)**+this.zoomSpeed),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new V,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){let t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){let t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100;break}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}};function dd(e){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(e.pointerId),this.domElement.ownerDocument.addEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.addEventListener(`pointerup`,this._onPointerUp)),!this._isTrackingPointer(e)&&(this._addPointer(e),e.pointerType===`touch`?this._onTouchStart(e):this._onMouseDown(e),this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grabbing`)))}function fd(e){this.enabled!==!1&&(e.pointerType===`touch`?this._onTouchMove(e):this._onMouseMove(e))}function pd(e){switch(this._removePointer(e),this._pointers.length){case 0:this.domElement.releasePointerCapture(e.pointerId),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.dispatchEvent(nd),this.state=cd.NONE,this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grab`);break;case 1:let t=this._pointers[0],n=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:n.x,pageY:n.y});break}}function md(t){let n;switch(t.button){case 0:n=this.mouseButtons.LEFT;break;case 1:n=this.mouseButtons.MIDDLE;break;case 2:n=this.mouseButtons.RIGHT;break;default:n=-1}switch(n){case e.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(t),this.state=cd.DOLLY;break;case e.ROTATE:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=cd.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=cd.ROTATE}break;case e.PAN:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=cd.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=cd.PAN}break;default:this.state=cd.NONE}this.state!==cd.NONE&&this.dispatchEvent(td)}function hd(e){switch(this.state){case cd.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(e);break;case cd.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(e);break;case cd.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(e);break}}function gd(e){this.enabled===!1||this.enableZoom===!1||this.state!==cd.NONE||(e.preventDefault(),this.dispatchEvent(td),this._handleMouseWheel(this._customWheelEvent(e)),this.dispatchEvent(nd))}function _d(e){this.enabled!==!1&&this._handleKeyDown(e)}function vd(e){switch(this._trackPointer(e),this._pointers.length){case 1:switch(this.touches.ONE){case t.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(e),this.state=cd.TOUCH_ROTATE;break;case t.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(e),this.state=cd.TOUCH_PAN;break;default:this.state=cd.NONE}break;case 2:switch(this.touches.TWO){case t.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(e),this.state=cd.TOUCH_DOLLY_PAN;break;case t.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(e),this.state=cd.TOUCH_DOLLY_ROTATE;break;default:this.state=cd.NONE}break;default:this.state=cd.NONE}this.state!==cd.NONE&&this.dispatchEvent(td)}function yd(e){switch(this._trackPointer(e),this.state){case cd.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(e),this.update();break;case cd.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(e),this.update();break;case cd.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(e),this.update();break;case cd.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(e),this.update();break;default:this.state=cd.NONE}}function bd(e){this.enabled!==!1&&e.preventDefault()}function xd(e){e.key===`Control`&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}function Sd(e){e.key===`Control`&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}var Cd=Math.PI*2,wd=.55,Td=.18,Ed=6.02,Dd=4.47,Od=1.34,kd=.74,Ad=5.02,jd=1/240,Md=22,Nd=9.81,Pd=13*Math.PI/180,Fd=.415,Id=.0075,Ld=.2,Rd=.075,zd=.1;function Bd(e,t,n){return Math.min(n,Math.max(t,e))}function Vd(e){return(e%Cd+Cd)%Cd}function Hd(e){let t=Vd(e);return t>Math.PI&&(t-=Cd),t}function Ud(e){return{x:0,y:Math.sin(e/2),z:0,w:Math.cos(e/2)}}function Wd(e,t){let n=t*.5,r=Math.sin(n);return{x:e.x*r,y:e.y*r,z:e.z*r,w:Math.cos(n)}}function Gd(){if(globalThis.crypto?.getRandomValues){let e=new Uint32Array(1);return globalThis.crypto.getRandomValues(e),e[0]/4294967296}return Math.random()}function Kd(e,t){return e+(t-e)*Gd()}function qd(e){if(e>=5.95)return 1.16;if(e<=Ad)return .76;let t=Bd((e-Ad)/(5.95-Ad),0,1);return .76+.3999999999999999*(t*t*(3-2*t))}function Jd(e,t,n,r){let i={x:Math.cos(t),z:Math.sin(t)},a={x:-Math.sin(t),z:Math.cos(t)};return{x:i.x*n+a.x*e*r,z:i.z*n+a.z*e*r}}function Yd(e,t,n){let r={x:Math.cos(t),z:Math.sin(t)},i={x:-Math.sin(t),z:Math.cos(t)};return{radial:n.x*r.x+n.z*r.z,angular:(n.x*i.x+n.z*i.z)/Math.max(e,1e-5)}}var Xd=class e{static async create(t){return new e(t)}constructor(e){this.order=[...e],this.accumulator=0,this.phase=`idle`,this.mode=`idle`,this.deflectors=Array.from({length:8},(e,t)=>({angle:t*Cd/8+Math.PI/8,radius:t%2==0?5.3:5.18,collisionRadius:.32999999999999996})),this.reset()}baseAngle(e){return Math.PI/2-e*Cd/this.order.length}setOrder(e){this.order=[...e],this.reset()}launch(){this.elapsed=0,this.accumulator=0,this.stableTime=0,this.betsClosed=!1,this.result=null,this.safetyResolved=!1,this.rotorAngle=Kd(0,Cd),this.rotorOmega=Kd(.22,.32),this.ballAngle=.15+Kd(-.035,.035),this.ballRadius=Ed,this.ballRadialVelocity=0,this.ballAngularVelocity=Kd(4.7,5.35),this.ballHeightOffset=0,this.ballVerticalVelocity=0,this.ballRollAngle=0,this.lastDeflectorTime=-1/0,this.lastSeparatorTime=-1/0,this.deflectorHits=0,this.separatorHits=0,this.criticalOmega=Math.sqrt(Nd/Ed*Math.tan(Pd)),this.phase=`betting-open`,this.mode=`rim`}step(e){if(this.phase===`idle`||this.phase===`resolved`)return this.snapshot();this.accumulator=Math.min(this.accumulator+Math.min(e,.1),jd*Md);let t=0;for(;this.accumulator>=jd&&t<Md;)this.fixedStep(jd),this.accumulator-=jd,t+=1;return this.snapshot()}fixedStep(e){this.elapsed+=e,this.rotorOmega*=Math.exp(-(this.mode===`pockets`?.055:.018)*e),this.rotorAngle=Vd(this.rotorAngle+this.rotorOmega*e),this.mode===`rim`?this.integrateRim(e):this.mode===`stator`?this.integrateStator(e):this.mode===`pockets`&&this.integratePockets(e),this.integrateVertical(e),this.ballRollAngle+=Math.abs(this.ballAngularVelocity*this.ballRadius)/Td*e,this.elapsed>22&&this.phase!==`resolved`&&(this.safetyResolved=!0,this.resolvePhysicalResult())}integrateRim(e){let t=Fd+Id*this.ballAngularVelocity**2;this.ballAngularVelocity=Math.max(0,this.ballAngularVelocity-t*e),this.ballAngle=Vd(this.ballAngle+this.ballAngularVelocity*e),this.ballRadius=Ed,this.ballAngularVelocity<=this.criticalOmega&&(this.betsClosed=!0,this.phase=`descending`,this.mode=`stator`,this.ballRadialVelocity=0)}integrateStator(e){let t=this.ballRadius*this.ballAngularVelocity**2*Math.cos(Pd)-Nd*Math.sin(Pd)-.72*this.ballRadialVelocity,n=-2*this.ballRadialVelocity*this.ballAngularVelocity/Math.max(this.ballRadius,.2)-Ld*this.ballAngularVelocity;this.ballRadialVelocity=Bd(this.ballRadialVelocity+t*e,-3.2,.9),this.ballAngularVelocity=Math.max(.12,this.ballAngularVelocity+n*e),this.ballRadius+=this.ballRadialVelocity*e,this.ballAngle=Vd(this.ballAngle+this.ballAngularVelocity*e),this.resolveDeflectorCollisions(),this.ballRadius<=Ad&&(this.ballRadius=Ad,this.mode=`pockets`,this.phase=`settling`,this.ballVerticalVelocity-=.18)}resolveDeflectorCollisions(){let e=Math.cos(this.ballAngle)*this.ballRadius,t=Math.sin(this.ballAngle)*this.ballRadius,n=Jd(this.ballRadius,this.ballAngle,this.ballRadialVelocity,this.ballAngularVelocity);for(let r of this.deflectors){if(this.elapsed-this.lastDeflectorTime<.05)break;let i=e-Math.cos(r.angle)*r.radius,a=t-Math.sin(r.angle)*r.radius,o=Math.hypot(i,a);if(o>=r.collisionRadius||o<1e-6)continue;let s=i/o,c=a/o,l=n.x*s+n.z*c;if(l>=0)continue;let u=-1.1400000000000001*l;n.x+=s*u,n.z+=c*u;let d=-c,f=s,p=n.x*d+n.z*f;n.x-=d*p*.12,n.z-=f*p*.12;let m=r.collisionRadius+.002,h=Math.cos(r.angle)*r.radius+s*m,g=Math.sin(r.angle)*r.radius+c*m;this.ballRadius=Math.hypot(h,g),this.ballAngle=Vd(Math.atan2(g,h));let _=Yd(this.ballRadius,this.ballAngle,n);this.ballRadialVelocity=Math.min(_.radial,-.1),this.ballAngularVelocity=_.angular,this.ballVerticalVelocity=Math.max(this.ballVerticalVelocity,Math.min(.34,u*.045)),this.lastDeflectorTime=this.elapsed,this.deflectorHits+=1;break}}integratePockets(e){let t=Dd,n=-14.5*(this.ballRadius-t)-5.8*this.ballRadialVelocity;this.ballRadialVelocity+=n*e,this.ballRadius+=this.ballRadialVelocity*e;let r=this.ballAngularVelocity+this.rotorOmega,i=this.ballHeightOffset>.02?.22:1.35;r*=Math.exp(-i*e),this.ballAngularVelocity=r-this.rotorOmega,this.ballAngle=Vd(this.ballAngle+this.ballAngularVelocity*e),this.resolveSeparatorCollision();let a=Math.abs((this.ballAngularVelocity+this.rotorOmega)*this.ballRadius);Math.abs(this.ballRadius-t)<.035&&Math.abs(this.ballRadialVelocity)<.045&&a<.12&&this.ballHeightOffset<.005&&Math.abs(this.ballVerticalVelocity)<.03?this.stableTime+=e:this.stableTime=Math.max(0,this.stableTime-e*.6),this.stableTime>.48&&this.resolvePhysicalResult()}resolveSeparatorCollision(){if(this.ballHeightOffset>.12)return;let e=Cd/this.order.length,t=Vd(this.ballAngle+this.rotorAngle),n=this.nearestPocketIndex(t),r=this.baseAngle(n),i=Hd(t-r),a=Math.asin(Bd(Td/this.ballRadius,0,.95)),o=Math.max(e*.18,e*.5-a),s=this.ballAngularVelocity+this.rotorOmega;if(Math.abs(i)<=o||Math.sign(i)!==Math.sign(s)||this.elapsed-this.lastSeparatorTime<.018)return;let c=Math.sign(i)*o;this.ballAngle=Vd(r+c-this.rotorAngle);let l=Math.abs(s*this.ballRadius);s=-s*zd,this.ballAngularVelocity=s-this.rotorOmega,this.ballVerticalVelocity=Math.max(this.ballVerticalVelocity,Math.min(.22,l*.028)),this.lastSeparatorTime=this.elapsed,this.separatorHits+=1}integrateVertical(e){if(this.ballHeightOffset<=0&&this.ballVerticalVelocity<=0){this.ballHeightOffset=0,this.ballVerticalVelocity=0;return}this.ballVerticalVelocity-=Nd*e,this.ballHeightOffset+=this.ballVerticalVelocity*e,this.ballHeightOffset<0&&(this.ballHeightOffset=0,Math.abs(this.ballVerticalVelocity)>.17?this.ballVerticalVelocity=-this.ballVerticalVelocity*Rd:this.ballVerticalVelocity=0)}nearestPocketIndex(e){let t=0,n=1/0;for(let r=0;r<this.order.length;r+=1){let i=Math.abs(Hd(e-this.baseAngle(r)));i<n&&(n=i,t=r)}return t}resolvePhysicalResult(){if(this.phase===`resolved`)return;let e=Vd(this.ballAngle+this.rotorAngle);this.result=this.order[this.nearestPocketIndex(e)],this.phase=`resolved`,this.mode=`resolved`,this.ballRadius=Dd,this.ballRadialVelocity=0,this.ballHeightOffset=0,this.ballVerticalVelocity=0,this.ballAngularVelocity=-this.rotorOmega}getCountdown(){if(this.betsClosed)return 0;let e=Fd,t=Id,n=Math.sqrt(t/e),r=(Math.atan(this.ballAngularVelocity*n)-Math.atan(this.criticalOmega*n))/Math.sqrt(e*t);return Math.max(0,Math.ceil(r))}ballWorldHeight(){return wd+(this.mode===`rim`?Od:this.mode===`stator`?qd(this.ballRadius)+Td:kd)+this.ballHeightOffset}snapshot(){let e=Math.cos(this.ballAngle)*this.ballRadius,t=Math.sin(this.ballAngle)*this.ballRadius,n=Jd(this.ballRadius,this.ballAngle,this.ballRadialVelocity,this.ballAngularVelocity),r={x:Math.cos(this.ballAngle),y:0,z:Math.sin(this.ballAngle)};return{phase:this.phase,mode:this.mode,elapsed:this.elapsed||0,betsClosed:!!this.betsClosed,countdown:this.getCountdown(),result:this.result,safetyResolved:!!this.safetyResolved,ballPosition:{x:e,y:this.ballWorldHeight(),z:t},ballRotation:Wd(r,this.ballRollAngle),ballVelocity:{x:n.x,y:this.ballVerticalVelocity,z:n.z},rotorRotation:Ud(this.rotorAngle),rotorOmega:this.rotorOmega||0,radius:this.ballRadius,relativeAngularVelocity:this.ballAngularVelocity+this.rotorOmega,deflectorHits:this.deflectorHits||0,separatorHits:this.separatorHits||0}}placeBallInPocket(e){let t=this.order.indexOf(String(e));t<0||(this.result=String(e),this.phase=`resolved`,this.mode=`resolved`,this.ballAngle=Vd(this.baseAngle(t)-this.rotorAngle),this.ballRadius=Dd,this.ballRadialVelocity=0,this.ballAngularVelocity=-this.rotorOmega,this.ballHeightOffset=0,this.ballVerticalVelocity=0)}reset(){this.phase=`idle`,this.mode=`idle`,this.elapsed=0,this.result=null,this.betsClosed=!1,this.rotorAngle=0,this.rotorOmega=0,this.ballAngle=.15,this.ballRadius=Ed,this.ballRadialVelocity=0,this.ballAngularVelocity=0,this.ballHeightOffset=0,this.ballVerticalVelocity=0,this.ballRollAngle=0,this.stableTime=0,this.safetyResolved=!1,this.deflectorHits=0,this.separatorHits=0}free(){}},Zd={MACHINE_Y:wd,BALL_RADIUS:Td,OUTER_TRACK_RADIUS:Ed,POCKET_RADIUS:Dd,OUTER_TRACK_Y:Od,POCKET_BALL_Y:kd,POCKET_ENTRY_RADIUS:Ad,PHYSICS_DT:jd,GRAVITY:Nd,STATOR_ANGLE:Pd},Qd=Math.PI*2,{MACHINE_Y:$d,BALL_RADIUS:ef,OUTER_TRACK_RADIUS:tf,POCKET_RADIUS:nf,OUTER_TRACK_Y:rf,POCKET_BALL_Y:af}=Zd,of=new Set([`1`,`3`,`5`,`7`,`9`,`12`,`14`,`16`,`18`,`19`,`21`,`23`,`25`,`27`,`30`,`32`,`34`,`36`]);function sf(e){return Math.min(1,Math.max(0,e))}function cf(e,t,n){return e+(t-e)*n}function lf(e){let t=sf(e);return t*t*(3-2*t)}function uf(e){return e===`0`||e===`00`?555600:of.has(e)?11937333:1053981}var df=class{constructor(){this.context=null,this.effectsEnabled=!0,this.ambienceEnabled=!0,this.masterVolume=.62,this.lastTick=0,this.masterGain=null,this.fxGain=null,this.ambienceGain=null,this.ambienceNodes=[],this.ambienceTimer=null}ensure(){if(!this.context){let e=window.AudioContext||window.webkitAudioContext;if(!e)return null;this.context=new e,this.masterGain=this.context.createGain(),this.fxGain=this.context.createGain(),this.ambienceGain=this.context.createGain(),this.masterGain.gain.value=this.masterVolume,this.fxGain.gain.value=1,this.ambienceGain.gain.value=1,this.fxGain.connect(this.masterGain),this.ambienceGain.connect(this.masterGain),this.masterGain.connect(this.context.destination)}return this.context}async unlock(){let e=this.ensure();return e?(e.state===`suspended`&&await e.resume(),this.ambienceEnabled&&this.startAmbience(),e.state===`running`):!1}setEffectsEnabled(e){this.effectsEnabled=!!e}setAmbienceEnabled(e){this.ambienceEnabled=!!e,this.ambienceEnabled?this.context?.state===`running`&&this.startAmbience():this.stopAmbience()}setMasterVolume(e){this.masterVolume=Math.max(0,Math.min(1,Number(e)||0)),this.masterGain&&this.context&&this.masterGain.gain.setTargetAtTime(this.masterVolume,this.context.currentTime,.035)}tone(e,t=.05,n=.015,r=`sine`,i=0,a=`fx`){if(a===`fx`&&!this.effectsEnabled||a===`ambience`&&!this.ambienceEnabled)return;let o=this.ensure();if(!o||o.state!==`running`)return;let s=o.currentTime+i,c=o.createOscillator(),l=o.createGain();c.type=r,c.frequency.setValueAtTime(e,s),l.gain.setValueAtTime(1e-4,s),l.gain.exponentialRampToValueAtTime(Math.max(2e-4,n),s+.008),l.gain.exponentialRampToValueAtTime(1e-4,s+t),c.connect(l).connect(a===`ambience`?this.ambienceGain:this.fxGain),c.start(s),c.stop(s+t+.04)}makeNoiseBuffer(e=4){let t=this.ensure(),n=Math.max(1,Math.floor(t.sampleRate*e)),r=t.createBuffer(1,n,t.sampleRate),i=r.getChannelData(0),a=0;for(let e=0;e<n;e+=1){let t=Math.random()*2-1;a=a*.985+t*.015,i[e]=a*3.4}return r}startAmbience(){if(!this.ambienceEnabled||this.ambienceNodes.length)return;let e=this.ensure();if(!e||e.state!==`running`)return;let t=e.createBufferSource();t.buffer=this.makeNoiseBuffer(5),t.loop=!0;let n=e.createBiquadFilter();n.type=`lowpass`,n.frequency.value=780,n.Q.value=.7;let r=e.createGain();r.gain.value=.032,t.connect(n).connect(r).connect(this.ambienceGain),t.start();let i=e.createBufferSource();i.buffer=this.makeNoiseBuffer(6),i.loop=!0;let a=e.createBiquadFilter();a.type=`bandpass`,a.frequency.value=430,a.Q.value=.55;let o=e.createGain();o.gain.value=.012,i.connect(a).connect(o).connect(this.ambienceGain),i.start();let s=e.createGain();s.gain.value=.012;let c=e.createBiquadFilter();c.type=`lowpass`,c.frequency.value=620,s.connect(c).connect(this.ambienceGain);let l=[110,138.59,164.81].map((t,n)=>{let r=e.createOscillator(),i=e.createGain();return r.type=n===1?`triangle`:`sine`,r.frequency.value=t,r.detune.value=(n-1)*3,i.gain.value=n===1?.42:.32,r.connect(i).connect(s),r.start(),r}),u=e.createOscillator(),d=e.createGain();u.frequency.value=.07,d.gain.value=.004,u.connect(d).connect(s.gain),u.start(),this.ambienceNodes=[t,i,...l,u];let f=()=>{if(!this.ambienceEnabled||!this.context||this.context.state!==`running`)return;let e=820+Math.random()*600;this.tone(e,.025,.0045,`triangle`,0,`ambience`),Math.random()>.55&&this.tone(e*1.22,.018,.003,`sine`,.055,`ambience`),this.ambienceTimer=window.setTimeout(f,3200+Math.random()*5200)};this.ambienceTimer=window.setTimeout(f,1800)}stopAmbience(){this.ambienceTimer&&window.clearTimeout(this.ambienceTimer),this.ambienceTimer=null;for(let e of this.ambienceNodes){try{e.stop?.()}catch{}try{e.disconnect?.()}catch{}}this.ambienceNodes=[]}launch(){this.tone(165,.11,.025,`sawtooth`),this.tone(390,.08,.014,`triangle`,.05)}rolling(e){let t=performance.now(),n=Math.max(42,145-e*10);t-this.lastTick<n||(this.lastTick=t,this.tone(590+e*55,.014,.0045,`square`))}deflector(){this.tone(1040,.024,.019,`square`),this.tone(630,.04,.012,`triangle`,.012)}pocket(){this.tone(480,.05,.02,`triangle`),this.tone(305,.09,.014,`sine`,.035)}win(){[523.25,659.25,783.99].forEach((e,t)=>this.tone(e,.22,.025,`sine`,t*.075))}lose(){this.tone(190,.16,.018,`triangle`)}dispose(){this.stopAmbience(),this.context?.close?.().catch?.(()=>{})}},ff=class{constructor(e,t={}){this.container=e,this.order=[...t.order||[]],this.onPocketClick=t.onPocketClick||null,this.reducedMotion=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,this.audio=new df,this.ready=!1,this.disposed=!1,this.spinning=!1,this.phase=`idle`,this.spinState=null,this.physics=null,this.lastPhysicsSnapshot=null,this.pointer=new V,this.raycaster=new ys,this.hoveredPocket=null,this.confetti=[],this.pulses=[]}async init(){try{return this.renderer=new Vu({antialias:!0,alpha:!1,powerPreference:`high-performance`}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio||1,1.75)),this.renderer.outputColorSpace=Be,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.04,this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=2,this.renderer.domElement.className=`roulette-webgl-canvas`,this.renderer.domElement.setAttribute(`aria-label`,`Interactive 3D roulette wheel. Drag to orbit and use the wheel or pinch to zoom.`),this.container.appendChild(this.renderer.domElement),this.scene=new In,this.scene.background=new G(397339),this.scene.fog=new Fn(397339,.022),this.cameraTarget=new H(0,.82,0),this.defaultCameraPosition=new H(0,12.9,9.3),this.camera=new Jo(35,1,.1,80),this.camera.position.copy(this.defaultCameraPosition),this.camera.lookAt(this.cameraTarget),this.controls=new ud(this.camera,this.renderer.domElement),this.controls.target.copy(this.cameraTarget),this.controls.enableDamping=!0,this.controls.dampingFactor=.075,this.controls.enablePan=!1,this.controls.minDistance=10.2,this.controls.maxDistance=18.2,this.controls.minPolarAngle=.4,this.controls.maxPolarAngle=1.08,this.controls.minAzimuthAngle=-.78,this.controls.maxAzimuthAngle=.78,this.controls.rotateSpeed=.42,this.controls.zoomSpeed=.78,this.controls.zoomToCursor=!0,this.controls.saveState(),this.buildLighting(),this.buildEnvironment(),this.buildMachine(),this.buildBall(),this.buildPostProcessing(),this.bindPointerInteraction(),this.physics=await Xd.create(this.order),this.syncPhysicsSnapshot(this.physics.snapshot()),this.resizeObserver=new ResizeObserver(()=>this.resize()),this.resizeObserver.observe(this.container),this.resize(),this.ready=!0,this.container.classList.add(`has-webgl`),this.animate=this.animate.bind(this),this.renderer.setAnimationLoop(this.animate),!0}catch(e){return console.error(`3D roulette initialization failed. Falling back to 2D.`,e),this.container.classList.add(`webgl-fallback`),!1}}buildLighting(){this.scene.add(new Io(13098495,1903622,1.7));let e=new $o(16768938,3.1);e.position.set(7,14,7),e.castShadow=!0,e.shadow.mapSize.set(1536,1536),e.shadow.camera.left=-9,e.shadow.camera.right=9,e.shadow.camera.top=9,e.shadow.camera.bottom=-9,this.scene.add(e);let t=new Xo(5619711,33,24,2);t.position.set(-6,6,-5),this.scene.add(t),this.resultLight=new Xo(16763231,0,14,2),this.resultLight.position.set(0,4.4,0),this.scene.add(this.resultLight)}buildEnvironment(){let e=new q(new Pi(25,96),new ho({color:465688,roughness:.96,metalness:.01}));e.rotation.x=-Math.PI/2,e.position.y=-.03,e.receiveShadow=!0,this.scene.add(e);let t=new q(new Fi(8.25,8.65,.72,96),new ho({color:408111,roughness:.78,metalness:.05}));t.position.y=.23,t.receiveShadow=!0,t.castShadow=!0,this.scene.add(t);let n=new q(new ro(8.12,.18,18,128),new ho({color:10250024,roughness:.3,metalness:.66}));n.rotation.x=Math.PI/2,n.position.y=.62,n.castShadow=!0,this.scene.add(n)}buildMachine(){this.machineRoot&&(this.scene.remove(this.machineRoot),this.disposeObject(this.machineRoot)),this.machineRoot=new Dn,this.machineRoot.position.y=.55,this.scene.add(this.machineRoot),this.buildStaticBowl(),this.buildRotor(),this.buildLauncher()}buildStaticBowl(){let e=new q(new Fi(6.44,6.56,.56,128),new ho({color:2692877,roughness:.26,metalness:.52}));e.castShadow=!0,e.receiveShadow=!0,this.machineRoot.add(e);let t=new q(new ro(6.21,.16,20,160),new ho({color:13935949,roughness:.18,metalness:.9,emissive:2954752,emissiveIntensity:.16}));t.rotation.x=Math.PI/2,t.position.y=.47,this.machineRoot.add(t);let n=new q(new ro(tf,.24,22,160),new ho({color:13152636,roughness:.23,metalness:.72}));n.rotation.x=Math.PI/2,n.position.y=1.13,n.castShadow=!0,n.receiveShadow=!0,this.machineRoot.add(n);let r=new q(new Za([new V(3.55,.42),new V(4.35,.48),new V(4.92,.58),new V(5.4,.79),new V(5.78,1.02),new V(5.98,1.18)],128),new ho({color:10652513,roughness:.32,metalness:.5,side:2}));r.castShadow=!0,r.receiveShadow=!0,this.machineRoot.add(r),this.deflectorGroup=new Dn;let i=new ho({color:14332509,roughness:.2,metalness:.86});for(let e=0;e<8;e++){let t=e*Qd/8+Math.PI/8,n=new q(new Ii(.15,.34,4),i),r=e%2==0?5.24:5.1;n.position.set(Math.cos(t)*r,this.surfaceHeight(r)+.17,Math.sin(t)*r),n.rotation.y=-t+Math.PI/4,n.castShadow=!0,this.deflectorGroup.add(n)}this.machineRoot.add(this.deflectorGroup)}buildRotor(){this.rotorGroup=new Dn,this.machineRoot.add(this.rotorGroup);let e=new q(new Fi(5.18,5.32,.46,128),new ho({color:1583163,roughness:.27,metalness:.57}));e.position.y=.32,e.castShadow=!0,e.receiveShadow=!0,this.rotorGroup.add(e),this.pocketsGroup=new Dn,this.pocketsGroup.position.y=.57,this.rotorGroup.add(this.pocketsGroup),this.pocketMeshes=[];let t=Qd/this.order.length,n=new ho({color:15187298,roughness:.2,metalness:.88});for(let e=0;e<this.order.length;e++){let r=this.baseAngle(e),i=this.order[e],a=new q(this.createHorizontalSectorGeometry(3.82,5.03,r-t*.48,r+t*.48),new ho({color:uf(i),roughness:.42,metalness:.2,emissive:uf(i),emissiveIntensity:.035,side:2}));a.userData={number:i,index:e,baseEmissive:.035},a.receiveShadow=!0,this.pocketsGroup.add(a),this.pocketMeshes.push(a);let o=this.createNumberLabel(i);o.position.set(Math.cos(r)*4.47,.055,Math.sin(r)*4.47),this.pocketsGroup.add(o);let s=r-t*.5,c=new q(new Ni(.045,.21,1.23),n);c.position.set(Math.cos(s)*4.42,.1,Math.sin(s)*4.42),c.rotation.y=-s+Math.PI/2,c.castShadow=!0,this.pocketsGroup.add(c)}let r=new q(new ro(5.06,.075,12,160),n);r.rotation.x=Math.PI/2,r.position.y=.12,this.pocketsGroup.add(r);let i=new q(new ro(3.79,.07,12,160),n);i.rotation.x=Math.PI/2,i.position.y=.12,this.pocketsGroup.add(i);let a=new q(new Fi(.92,3.68,.68,96),new ho({color:1586768,roughness:.25,metalness:.56}));a.position.y=.73,a.castShadow=!0,this.rotorGroup.add(a);let o=new q(new Fi(.92,1.22,.78,64),new ho({color:14265167,roughness:.17,metalness:.9,emissive:2889216,emissiveIntensity:.18}));o.position.y=1.24,o.castShadow=!0,this.rotorGroup.add(o);let s=new q(new Fi(.12,.17,1.75,24),new ho({color:16767362,roughness:.12,metalness:.96}));s.position.y=2.16,this.rotorGroup.add(s);let c=new q(new no(.31,28,18),new ho({color:16765290,roughness:.14,metalness:.92}));c.position.y=3.04,this.rotorGroup.add(c)}buildLauncher(){let e=new Dn,t=.15;e.position.set(Math.cos(t)*6.34,1.28,Math.sin(t)*6.34),e.rotation.y=-.15;let n=new q(new Ni(.48,.38,1.05),new ho({color:2108217,roughness:.27,metalness:.72}));n.castShadow=!0,e.add(n);let r=new q(new Fi(.16,.19,.52,28),new ho({color:12952936,roughness:.18,metalness:.82}));r.rotation.x=Math.PI/2,r.position.z=-.49,e.add(r),this.machineRoot.add(e)}buildBall(){let e=new go({color:16777215,roughness:.07,metalness:.16,clearcoat:1,clearcoatRoughness:.07,emissive:12049663,emissiveIntensity:.05});this.ball=new q(new no(ef,32,22),e),this.ball.castShadow=!0,this.machineRoot.add(this.ball),this.ballGlow=new q(new no(.25,24,16),new ai({color:11460607,transparent:!0,opacity:.075,blending:2,depthWrite:!1})),this.machineRoot.add(this.ballGlow),this.updateBallTransform()}buildPostProcessing(){this.composer=new Xu(this.renderer),this.composer.addPass(new Zu(this.scene,this.camera)),this.bloomPass=new $u(new V(1,1),.38,.34,.86),this.composer.addPass(this.bloomPass)}createHorizontalSectorGeometry(e,t,n,r){let i=new pa;for(let e=0;e<=8;e++){let a=cf(n,r,e/8),o=Math.cos(a)*t,s=-Math.sin(a)*t;e===0?i.moveTo(o,s):i.lineTo(o,s)}for(let t=8;t>=0;t--){let a=cf(n,r,t/8);i.lineTo(Math.cos(a)*e,-Math.sin(a)*e)}i.closePath();let a=new eo(i,8);return a.rotateX(-Math.PI/2),a.computeVertexNormals(),a}createNumberLabel(e){let t=document.createElement(`canvas`);t.width=128,t.height=128;let n=t.getContext(`2d`);n.clearRect(0,0,128,128),n.fillStyle=`#ffffff`,n.font=`900 ${String(e).length>1?46:54}px Arial`,n.textAlign=`center`,n.textBaseline=`middle`,n.shadowColor=`rgba(0,0,0,.75)`,n.shadowBlur=8,n.fillText(String(e),64,66);let r=new ki(t);r.colorSpace=Be;let i=new Yr(new Fr({map:r,transparent:!0,depthTest:!0}));return i.scale.set(.64,.64,.64),i}surfaceHeight(e){return e>=5.95?1.16:e<=4.45?.58:cf(.58,1.16,lf((e-4.45)/1.5))}baseAngle(e){return Math.PI/2-e*Qd/this.order.length}bindPointerInteraction(){let e=this.renderer.domElement,t=null,n=!1,r=t=>{let n=e.getBoundingClientRect();return this.pointer.x=(t.clientX-n.left)/n.width*2-1,this.pointer.y=-((t.clientY-n.top)/n.height)*2+1,this.raycaster.setFromCamera(this.pointer,this.camera),this.raycaster.intersectObjects(this.pocketMeshes,!1)[0]?.object||null};e.addEventListener(`pointerdown`,r=>{t={x:r.clientX,y:r.clientY},n=!1,e.classList.add(`is-grabbing`)}),e.addEventListener(`pointermove`,i=>{if(t&&Math.hypot(i.clientX-t.x,i.clientY-t.y)>6&&(n=!0),n){this.hoveredPocket&&(this.hoveredPocket.material.emissiveIntensity=this.hoveredPocket.userData.baseEmissive),this.hoveredPocket=null,e.style.cursor=`grabbing`;return}let a=r(i);this.hoveredPocket&&this.hoveredPocket!==a&&(this.hoveredPocket.material.emissiveIntensity=this.hoveredPocket.userData.baseEmissive),this.hoveredPocket=a,a?(a.material.emissiveIntensity=.25,e.style.cursor=`pointer`):e.style.cursor=`grab`}),e.addEventListener(`pointerup`,i=>{e.classList.remove(`is-grabbing`);let a=t&&!n;if(t=null,!a)return;let o=r(i);o&&typeof this.onPocketClick==`function`&&this.onPocketClick(o.userData.number)}),e.addEventListener(`pointercancel`,()=>{t=null,n=!1,e.classList.remove(`is-grabbing`)}),e.addEventListener(`pointerleave`,()=>{this.hoveredPocket&&(this.hoveredPocket.material.emissiveIntensity=this.hoveredPocket.userData.baseEmissive),this.hoveredPocket=null,t=null,n=!1,e.classList.remove(`is-grabbing`),e.style.cursor=`grab`})}emit(e,t={}){this.container.dispatchEvent(new CustomEvent(e,{detail:t}));let n={"roulette-phase":`onPhase`,"roulette-countdown":`onCountdown`,"roulette-bets-closed":`onBetsClosed`}[e];n&&typeof this.spinState?.hooks?.[n]==`function`&&this.spinState.hooks[n](t)}setPhase(e,t={}){this.phase!==e&&(this.phase=e,this.container.dataset.phase=e,this.emit(`roulette-phase`,{phase:e,...t}))}setOrder(e){this.machineRoot&&this.ball&&(this.machineRoot.remove(this.ball),this.machineRoot.remove(this.ballGlow)),this.order=[...e],this.buildMachine(),this.ball&&(this.machineRoot.add(this.ball),this.machineRoot.add(this.ballGlow)),this.physics?.setOrder(this.order),this.physics&&this.syncPhysicsSnapshot(this.physics.snapshot())}setSound(e){this.audio.setEffectsEnabled(e)}setAmbience(e){this.audio.setAmbienceEnabled(e)}setMasterVolume(e){this.audio.setMasterVolume(e)}unlockAudio(){return this.audio.unlock()}resetCamera(){this.controls&&(this.controls.reset(),this.camera.position.copy(this.defaultCameraPosition),this.controls.target.copy(this.cameraTarget),this.controls.update())}getCameraState(){return{position:this.camera?.position?.toArray?.()||[],target:this.controls?.target?.toArray?.()||[]}}spin(e={}){if(!this.ready||this.spinning||!this.physics)return Promise.resolve(null);this.clearEffects(),this.audio.launch(),this.spinning=!0,this.container.classList.add(`is-spinning`),this.container.classList.remove(`is-win`,`is-loss`,`is-push`),this.physics.launch();let t=this.physics.snapshot();return this.syncPhysicsSnapshot(t),this.spinState={hooks:e,resolve:null,lastCountdown:null,betsClosed:!1,lastMode:t.mode,lastPhase:t.phase},this.setPhase(`betting-open`,{seconds:t.countdown}),new Promise(e=>{this.spinState.resolve=e})}spinTo(e,t={}){return this.spin(t)}updatePhysicalSpin(e){let t=this.spinState;if(!t||!this.physics)return;let n=this.physics.step(e);this.syncPhysicsSnapshot(n),!n.betsClosed&&n.countdown!==t.lastCountdown&&(t.lastCountdown=n.countdown,this.emit(`roulette-countdown`,{seconds:n.countdown})),n.betsClosed&&!t.betsClosed&&(t.betsClosed=!0,this.setPhase(`bets-closed`),this.emit(`roulette-bets-closed`,{resultPending:!0})),n.phase!==t.lastPhase&&(t.lastPhase=n.phase,n.phase===`descending`&&this.setPhase(`descending`),n.phase===`settling`&&(this.audio.deflector(),this.setPhase(`settling`)));let r=n.ballVelocity,i=Math.hypot(r.x,r.y,r.z);i>.25&&this.audio.rolling(Math.min(8,i*.45)),n.phase===`resolved`&&n.result!=null&&this.finishPhysicalSpin(n.result)}finishPhysicalSpin(e){let t=this.spinState;if(!t)return;this.audio.pocket();let n=t.resolve;this.spinState=null,this.spinning=!1,this.container.classList.remove(`is-spinning`),this.setPhase(`resolved`,{result:e}),n&&n(String(e))}syncPhysicsSnapshot(e){if(!e||!this.ball||!this.rotorGroup)return;this.lastPhysicsSnapshot=e;let t=e.ballPosition,n=e.ballRotation,r=e.rotorRotation;this.ball.position.set(t.x,t.y-$d,t.z),this.ball.quaternion.set(n.x,n.y,n.z,n.w),this.ballGlow.position.copy(this.ball.position),this.rotorGroup.quaternion.set(r.x,r.y,r.z,r.w)}resolveResult(e,t){if(!this.ready)return Promise.resolve();let n=e>0,r=e<0;return this.resultLight.color.set(n?16762977:r?16734570:8038399),this.resultLight.intensity=n?52:r?18:12,this.container.classList.add(n?`is-win`:r?`is-loss`:`is-push`),n?(this.audio.win(),this.spawnConfetti(uf(String(t))),this.spawnPulse(16767093)):r&&(this.audio.lose(),this.spawnPulse(16734570)),this.highlightPocket(String(t),n),new Promise(e=>window.setTimeout(e,this.reducedMotion?260:650))}highlightPocket(e,t){let n=this.pocketMeshes.find(t=>t.userData.number===e);n&&(n.material.emissive.set(t?16760133:5945343),n.material.emissiveIntensity=t?1:.65,window.setTimeout(()=>{n.material.emissive.set(uf(e)),n.material.emissiveIntensity=n.userData.baseEmissive},this.reducedMotion?420:1500))}setResult(e){!this.ready||!this.physics||(this.physics.placeBallInPocket(String(e)),this.syncPhysicsSnapshot(this.physics.snapshot()))}reset(){this.clearEffects(),this.spinState=null,this.spinning=!1,this.phase=`idle`,this.physics?.reset(),this.physics&&this.syncPhysicsSnapshot(this.physics.snapshot()),this.container.classList.remove(`is-spinning`,`is-win`,`is-loss`,`is-push`)}spawnConfetti(e){if(!this.reducedMotion)for(let t=0;t<52;t++){let n=new q(new Qa(.1,.19),new ai({color:t%3==0?16766826:e,side:2}));n.position.set((Math.random()-.5)*4,4.2+Math.random()*2.5,(Math.random()-.5)*4),this.scene.add(n),this.confetti.push({mesh:n,velocity:new H((Math.random()-.5)*2.2,.2+Math.random()*1.4,(Math.random()-.5)*2.2),spin:new H(Math.random()*5,Math.random()*5,Math.random()*5),life:2.3+Math.random()*1.2})}}spawnPulse(e){let t=new q(new $a(3.8,3.9,96),new ai({color:e,transparent:!0,opacity:.55,side:2,depthWrite:!1}));t.rotation.x=-Math.PI/2,t.position.y=1.16,this.scene.add(t),this.pulses.push({mesh:t,life:1})}updateEffects(e){for(let t=this.confetti.length-1;t>=0;t--){let n=this.confetti[t];n.life-=e,n.velocity.y-=2.7*e,n.mesh.position.addScaledVector(n.velocity,e),n.mesh.rotation.x+=n.spin.x*e,n.mesh.rotation.y+=n.spin.y*e,n.mesh.rotation.z+=n.spin.z*e,n.life<=0&&(this.scene.remove(n.mesh),n.mesh.geometry.dispose(),n.mesh.material.dispose(),this.confetti.splice(t,1))}for(let t=this.pulses.length-1;t>=0;t--){let n=this.pulses[t];n.life-=e;let r=1-n.life;n.mesh.scale.setScalar(1+r*.55),n.mesh.material.opacity=Math.max(0,n.life)*.55,n.life<=0&&(this.scene.remove(n.mesh),n.mesh.geometry.dispose(),n.mesh.material.dispose(),this.pulses.splice(t,1))}this.resultLight.intensity*=.08**e}clearEffects(){this.container.classList.remove(`is-win`,`is-loss`,`is-push`);for(let e of this.confetti)this.scene.remove(e.mesh),e.mesh.geometry.dispose(),e.mesh.material.dispose();for(let e of this.pulses)this.scene.remove(e.mesh),e.mesh.geometry.dispose(),e.mesh.material.dispose();this.confetti=[],this.pulses=[],this.resultLight&&(this.resultLight.intensity=0)}updateBallTransform(){this.physics&&this.syncPhysicsSnapshot(this.physics.snapshot())}animate(e){if(this.disposed)return;this.lastFrame||=e;let t=Math.min(.05,Math.max(0,(e-this.lastFrame)/1e3));this.lastFrame=e,this.spinState&&this.updatePhysicalSpin(t),this.controls?.update(),this.updateEffects(t),this.ballGlow.material.opacity=.058+Math.sin(e*.004)*.01,this.bloomPass.strength=.34+this.resultLight.intensity/52*.38,this.composer.render()}resize(){if(!this.renderer||!this.camera)return;let e=Math.max(1,this.container.clientWidth),t=Math.max(1,this.container.clientHeight);this.renderer.setSize(e,t,!1),this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.composer.setSize(e,t),this.bloomPass.setSize(e,t)}disposeObject(e){e.traverse(e=>{e.geometry?.dispose?.(),Array.isArray(e.material)?e.material.forEach(e=>e.dispose?.()):e.material?.dispose?.(),e.material?.map&&e.material.map.dispose?.()})}dispose(){this.disposed=!0,this.renderer?.setAnimationLoop(null),this.resizeObserver?.disconnect(),this.clearEffects(),this.disposeObject(this.scene),this.controls?.dispose?.(),this.audio?.dispose?.(),this.composer?.dispose?.(),this.physics?.free(),this.renderer?.dispose(),this.renderer?.domElement?.remove()}},pf=`0.32.15.19.4.21.2.25.17.34.6.27.13.36.11.30.8.23.10.5.24.16.33.1.20.14.31.9.22.18.29.7.28.12.35.3.26`.split(`.`),mf=`0.28.9.26.30.11.7.20.32.17.5.22.34.15.3.24.36.13.1.00.27.10.25.29.12.8.19.31.18.6.21.33.16.4.23.35.14.2`.split(`.`),hf=new Set([`1`,`3`,`5`,`7`,`9`,`12`,`14`,`16`,`18`,`19`,`21`,`23`,`25`,`27`,`30`,`32`,`34`,`36`]),gf={zh:{locale:`zh-CN`,currency:`¥`,eyebrow:`交互式概率教育工具`,title:`轮盘实验室：为什么赌场长期占优`,learnMore:`知识点`,educationalOnly:`仅供概率教育，不提供真钱赌博`,heroTitle:`你可能短期赢钱，但规则保证赌场长期盈利。`,heroBody:`亲自旋转轮盘或批量模拟数千局，观察随机波动如何围绕负数学期望展开。`,coreFormulaLabel:`长期预计损失`,coreFormula:`总投注流水 × 赌场优势`,euLabel:`欧式轮盘`,usLabel:`美式轮盘`,bankerLabel:`百家庄押庄`,blackjackLabel:`21点基本策略`,stepOne:`步骤 1`,configureBet:`设置下注`,reset:`重置`,wheelType:`轮盘类型`,european:`欧式单零（37格）`,american:`美式双零（38格）`,startingBankroll:`初始资金`,betAmount:`每局下注`,betType:`下注类型`,chooseNumber:`选择号码`,interactiveBet:`交互下注台`,betTable:`点击号码或外围下注`,betTableHint:`发球后仍可在倒计时结束前修改下注；小球离开外轨时立即停止下注。`,soundEffects:`声音效果`,dragHint:`固定全景 · 发球前可拖动调整视角 · 点击号码下注`,readyToLaunch:`准备发球`,bettingOpen:`可下注`,betsCloseIn:`下注倒计时`,noMoreBets:`停止下注`,descending:`停止下注 · 小球离开外轨，等待开奖`,settling:`小球落袋中`,wonBanner:`本局获胜`,lostBanner:`本局落败`,winProbability:`中奖概率`,payout:`净赔率`,houseEdge:`赌场优势`,expectedLossBet:`每注预计损失`,spin:`发球`,batchRun:`批量模拟`,batchSize:`批量局数`,stepTwo:`步骤 2`,observeResult:`观察结果`,lastResult:`最近结果`,win:`赢`,loss:`输`,push:`和局`,noResult:`尚无结果`,stepThree:`步骤 3`,compareReality:`比较实际波动与理论损失`,varianceNote:`短期结果可能偏离理论值；局数越多，赌场优势越容易显现。`,bankroll:`当前资金`,spins:`完成局数`,totalWagered:`累计流水`,actualProfit:`实际盈亏`,expectedProfit:`理论期望盈亏`,observedReturn:`实际返还率`,actualLine:`实际累计盈亏`,expectedLine:`理论期望盈亏`,knowledgeKicker:`关键知识点`,knowledgeTitle:`为什么策略无法消除赌场优势`,turnoverTitle:`真正决定损失的是流水`,turnoverBody:`带着100元并不代表最多只下注100元。同一笔钱赢回后再次下注，会形成数倍甚至数十倍流水。`,example:`例`,fallacyTitle:`连续出红，不会让黑“该出了”`,fallacyBody:`独立轮盘的下一局概率不会被之前结果改变。寻找“冷热号”只是把随机波动误认为规律。`,martingaleTitle:`翻倍下注不能改变数学期望`,martingaleBody:`马丁格尔策略把许多小赢换成一次巨大亏损。连续6次失利后，10元起注累计需要630元。`,varianceTitle:`短期赢钱不证明系统有效`,varianceBody:`负期望游戏仍会产生赢家；问题在于重复足够多次后，平均结果会向负期望靠拢。`,comparisonKicker:`典型比较`,comparisonTitle:`每下注100元的长期平均损失`,game:`项目`,conditions:`条件`,typicalEdge:`典型赌场优势`,lossPerHundred:`每100元预计损失`,blackjack:`21点`,blackjackCondition:`良好规则＋严格基本策略`,baccarat:`百家庄`,baccaratCondition:`只押庄，标准5%佣金`,frenchRoulette:`法式轮盘`,europeanRoulette:`欧式轮盘`,americanRoulette:`美式轮盘`,singleZero:`单零`,doubleZero:`双零`,comparisonNote:`这些是常见规则下的近似值；具体桌面规则、下注速度和错误决策会改变实际损失。`,responsibleKicker:`负责任娱乐`,responsibleTitle:`最有效的“策略”是限制金额和时间。`,responsibleOne:`只使用可以完全损失的娱乐预算。`,responsibleTwo:`不要追损，不借钱，不把赌博当作收入来源。`,responsibleThree:`预先设定停止时间和损失上限。`,footerText:`Roulette Lab 是开源教育演示。所有模拟均在本地浏览器中运行，不收集数据。`,rngNote:`随机数来源：`,betRed:`红色`,betBlack:`黑色`,betOdd:`奇数`,betEven:`偶数`,betLow:`小（1–18）`,betHigh:`大（19–36）`,betDozen1:`第一打（1–12）`,betDozen2:`第二打（13–24）`,betDozen3:`第三打（25–36）`,betColumn1:`第一列`,betColumn2:`第二列`,betColumn3:`第三列`,betStraight:`单个号码`,insufficient:`资金不足，无法继续下注。请降低下注额或重置。`,invalidInput:`请输入有效的初始资金和下注金额。`,batchDone:`批量模拟完成。`,batchStopped:`资金不足，模拟提前停止。`,spinning:`小球已发出，倒计时内仍可修改下注。`,resetDone:`模拟已重置。`},en:{locale:`en-CA`,currency:`$`,eyebrow:`Interactive probability education`,title:`Roulette Lab: Why the House Wins`,learnMore:`Key ideas`,educationalOnly:`Educational simulation only — no real-money gambling`,heroTitle:`You can win in the short run. The rules make the house win in the long run.`,heroBody:`Spin once or simulate thousands of rounds to see random variance orbit a negative expected value.`,coreFormulaLabel:`Long-run expected loss`,coreFormula:`Total amount wagered × house edge`,euLabel:`European roulette`,usLabel:`American roulette`,bankerLabel:`Baccarat — Banker`,blackjackLabel:`Blackjack basic strategy`,stepOne:`Step 1`,configureBet:`Configure a bet`,reset:`Reset`,wheelType:`Wheel type`,european:`European single-zero (37)`,american:`American double-zero (38)`,startingBankroll:`Starting bankroll`,betAmount:`Bet per spin`,betType:`Bet type`,chooseNumber:`Choose a number`,interactiveBet:`Interactive betting table`,betTable:`Click a number or outside bet`,betTableHint:`You may change the bet until the countdown ends. Betting closes when the ball leaves the outer track.`,soundEffects:`Sound effects`,dragHint:`Fixed wide view · Adjust the camera before launch · Click a pocket to bet`,readyToLaunch:`Ready to launch`,bettingOpen:`Betting open`,betsCloseIn:`Bets close in`,noMoreBets:`No more bets`,descending:`No more bets · Ball has left the outer track`,settling:`Ball entering the pockets`,wonBanner:`Round won`,lostBanner:`Round lost`,winProbability:`Win probability`,payout:`Net payout`,houseEdge:`House edge`,expectedLossBet:`Expected loss per bet`,spin:`Launch ball`,batchRun:`Run batch`,batchSize:`Batch size`,stepTwo:`Step 2`,observeResult:`Observe the result`,lastResult:`Latest result`,win:`Win`,loss:`Loss`,push:`Push`,noResult:`No result yet`,stepThree:`Step 3`,compareReality:`Compare variance with expected loss`,varianceNote:`Short-run results can deviate sharply; the house edge becomes clearer as wagers accumulate.`,bankroll:`Current bankroll`,spins:`Spins completed`,totalWagered:`Total wagered`,actualProfit:`Actual profit/loss`,expectedProfit:`Expected profit/loss`,observedReturn:`Observed return`,actualLine:`Actual cumulative P/L`,expectedLine:`Expected cumulative P/L`,knowledgeKicker:`Key concepts`,knowledgeTitle:`Why betting systems cannot remove the house edge`,turnoverTitle:`Turnover drives expected loss`,turnoverBody:`Bringing 100 does not mean you only wager 100. Re-betting returned money can create many times your starting bankroll in turnover.`,example:`Example`,fallacyTitle:`A red streak does not make black “due”`,fallacyBody:`On an independent wheel, previous outcomes do not change the next spin. Hot and cold numbers are random variation dressed as a pattern.`,martingaleTitle:`Doubling does not change expected value`,martingaleBody:`Martingale converts many small wins into one very large loss. After six losses, a 10-unit base bet requires 630 units in total.`,varianceTitle:`A short-term win proves nothing`,varianceBody:`Negative-expectation games still produce winners. With repetition, average results tend to move toward the negative expectation.`,comparisonKicker:`Typical comparison`,comparisonTitle:`Long-run average loss per 100 wagered`,game:`Game`,conditions:`Conditions`,typicalEdge:`Typical house edge`,lossPerHundred:`Expected loss per 100`,blackjack:`Blackjack`,blackjackCondition:`Good rules + strict basic strategy`,baccarat:`Baccarat`,baccaratCondition:`Banker only, standard 5% commission`,frenchRoulette:`French roulette`,europeanRoulette:`European roulette`,americanRoulette:`American roulette`,singleZero:`Single zero`,doubleZero:`Double zero`,comparisonNote:`Approximate values under common rules. Table rules, betting speed, and decision errors change actual losses.`,responsibleKicker:`Responsible play`,responsibleTitle:`The most effective “strategy” is limiting money and time.`,responsibleOne:`Use only an entertainment budget you can lose completely.`,responsibleTwo:`Do not chase losses, borrow, or treat gambling as income.`,responsibleThree:`Set a stop time and loss limit before starting.`,footerText:`Roulette Lab is an open educational demo. Simulations run locally in your browser and collect no data.`,rngNote:`Randomness source:`,betRed:`Red`,betBlack:`Black`,betOdd:`Odd`,betEven:`Even`,betLow:`Low (1–18)`,betHigh:`High (19–36)`,betDozen1:`1st dozen (1–12)`,betDozen2:`2nd dozen (13–24)`,betDozen3:`3rd dozen (25–36)`,betColumn1:`1st column`,betColumn2:`2nd column`,betColumn3:`3rd column`,betStraight:`Straight-up number`,insufficient:`Not enough bankroll for another bet. Lower the bet or reset.`,invalidInput:`Enter a valid starting bankroll and bet amount.`,batchDone:`Batch simulation complete.`,batchStopped:`Simulation stopped early because the bankroll was exhausted.`,spinning:`Ball launched. You may change the bet until the countdown ends.`,resetDone:`Simulation reset.`},fr:{locale:`fr-CA`,currency:`$`,eyebrow:`Outil interactif de probabilités`,title:`Laboratoire de roulette : pourquoi la maison gagne`,learnMore:`Notions clés`,educationalOnly:`Simulation éducative seulement — aucun jeu d’argent réel`,heroTitle:`On peut gagner à court terme. Les règles font gagner la maison à long terme.`,heroBody:`Lancez une partie ou simulez des milliers de tours pour voir la variance aléatoire autour d’une espérance négative.`,coreFormulaLabel:`Perte prévue à long terme`,coreFormula:`Mises totales × avantage de la maison`,euLabel:`Roulette européenne`,usLabel:`Roulette américaine`,bankerLabel:`Baccara — Banque`,blackjackLabel:`Blackjack stratégie de base`,stepOne:`Étape 1`,configureBet:`Configurer la mise`,reset:`Réinitialiser`,wheelType:`Type de roulette`,european:`Européenne à un zéro (37)`,american:`Américaine à deux zéros (38)`,startingBankroll:`Capital initial`,betAmount:`Mise par tour`,betType:`Type de mise`,chooseNumber:`Choisir un numéro`,interactiveBet:`Table de mise interactive`,betTable:`Cliquez un numéro ou une mise extérieure`,betTableHint:`Vous pouvez modifier la mise jusqu’à la fin du compte à rebours. Les mises ferment lorsque la bille quitte la piste extérieure.`,soundEffects:`Effets sonores`,dragHint:`Vue générale fixe · Ajustez la caméra avant le lancement · Cliquez pour miser`,readyToLaunch:`Prêt à lancer`,bettingOpen:`Mises ouvertes`,betsCloseIn:`Fermeture dans`,noMoreBets:`Rien ne va plus`,descending:`Rien ne va plus · La bille quitte la piste extérieure`,settling:`La bille entre dans les cases`,wonBanner:`Manche gagnée`,lostBanner:`Manche perdue`,winProbability:`Probabilité de gain`,payout:`Gain net`,houseEdge:`Avantage maison`,expectedLossBet:`Perte prévue par mise`,spin:`Lancer la bille`,batchRun:`Simulation en lot`,batchSize:`Nombre de tours`,stepTwo:`Étape 2`,observeResult:`Observer le résultat`,lastResult:`Dernier résultat`,win:`Gagné`,loss:`Perdu`,push:`Égalité`,noResult:`Aucun résultat`,stepThree:`Étape 3`,compareReality:`Comparer la variance à la perte prévue`,varianceNote:`Les résultats à court terme peuvent s’écarter fortement; l’avantage maison devient plus visible avec le volume de mises.`,bankroll:`Capital actuel`,spins:`Tours effectués`,totalWagered:`Total misé`,actualProfit:`Gain/perte réel`,expectedProfit:`Gain/perte prévu`,observedReturn:`Taux de retour observé`,actualLine:`Gain/perte cumulé réel`,expectedLine:`Gain/perte cumulé prévu`,knowledgeKicker:`Notions clés`,knowledgeTitle:`Pourquoi les systèmes de mise n’annulent pas l’avantage maison`,turnoverTitle:`Le volume de mises détermine la perte`,turnoverBody:`Arriver avec 100 ne signifie pas miser seulement 100. Rejouer les gains peut créer un volume plusieurs fois supérieur au capital initial.`,example:`Exemple`,fallacyTitle:`Une série rouge ne rend pas le noir « dû »`,fallacyBody:`Sur une roulette indépendante, les résultats précédents ne changent pas le prochain tour. Les numéros chauds ou froids sont de la variance prise pour un motif.`,martingaleTitle:`Doubler ne change pas l’espérance`,martingaleBody:`La martingale transforme beaucoup de petits gains en une très grosse perte. Après six pertes, une mise de base de 10 exige 630 au total.`,varianceTitle:`Un gain à court terme ne prouve rien`,varianceBody:`Un jeu à espérance négative produit quand même des gagnants. Avec la répétition, la moyenne tend vers l’espérance négative.`,comparisonKicker:`Comparaison typique`,comparisonTitle:`Perte moyenne à long terme par 100 misés`,game:`Jeu`,conditions:`Conditions`,typicalEdge:`Avantage maison typique`,lossPerHundred:`Perte prévue par 100`,blackjack:`Blackjack`,blackjackCondition:`Bonnes règles + stratégie de base stricte`,baccarat:`Baccara`,baccaratCondition:`Banque seulement, commission standard de 5 %`,frenchRoulette:`Roulette française`,europeanRoulette:`Roulette européenne`,americanRoulette:`Roulette américaine`,singleZero:`Un zéro`,doubleZero:`Deux zéros`,comparisonNote:`Valeurs approximatives selon des règles courantes. Les règles, la vitesse de jeu et les erreurs modifient la perte réelle.`,responsibleKicker:`Jeu responsable`,responsibleTitle:`La meilleure « stratégie » est de limiter l’argent et le temps.`,responsibleOne:`N’utilisez qu’un budget de loisir que vous pouvez perdre entièrement.`,responsibleTwo:`Ne poursuivez pas les pertes, n’empruntez pas et ne traitez pas le jeu comme un revenu.`,responsibleThree:`Fixez une heure d’arrêt et une limite de perte avant de commencer.`,footerText:`Roulette Lab est une démonstration éducative ouverte. Les simulations s’exécutent localement et ne collectent aucune donnée.`,rngNote:`Source aléatoire :`,betRed:`Rouge`,betBlack:`Noir`,betOdd:`Impair`,betEven:`Pair`,betLow:`Manque (1–18)`,betHigh:`Passe (19–36)`,betDozen1:`1re douzaine (1–12)`,betDozen2:`2e douzaine (13–24)`,betDozen3:`3e douzaine (25–36)`,betColumn1:`1re colonne`,betColumn2:`2e colonne`,betColumn3:`3e colonne`,betStraight:`Plein (un numéro)`,insufficient:`Capital insuffisant pour une autre mise. Réduisez la mise ou réinitialisez.`,invalidInput:`Entrez un capital initial et une mise valides.`,batchDone:`Simulation en lot terminée.`,batchStopped:`Simulation arrêtée : capital épuisé.`,spinning:`Bille lancée. Vous pouvez modifier la mise jusqu’à la fin du compte à rebours.`,resetDone:`Simulation réinitialisée.`}},_f={red:{label:`betRed`,payout:1,match:e=>hf.has(e)},black:{label:`betBlack`,payout:1,match:e=>e!==`0`&&e!==`00`&&!hf.has(e)},odd:{label:`betOdd`,payout:1,match:e=>Number(e)>=1&&Number(e)%2==1},even:{label:`betEven`,payout:1,match:e=>Number(e)>=1&&Number(e)%2==0},low:{label:`betLow`,payout:1,match:e=>Number(e)>=1&&Number(e)<=18},high:{label:`betHigh`,payout:1,match:e=>Number(e)>=19&&Number(e)<=36},dozen1:{label:`betDozen1`,payout:2,match:e=>Number(e)>=1&&Number(e)<=12},dozen2:{label:`betDozen2`,payout:2,match:e=>Number(e)>=13&&Number(e)<=24},dozen3:{label:`betDozen3`,payout:2,match:e=>Number(e)>=25&&Number(e)<=36},column1:{label:`betColumn1`,payout:2,match:e=>Number(e)>=1&&(Number(e)-1)%3==0},column2:{label:`betColumn2`,payout:2,match:e=>Number(e)>=1&&(Number(e)-2)%3==0},column3:{label:`betColumn3`,payout:2,match:e=>Number(e)>=1&&Number(e)%3==0},straight:{label:`betStraight`,payout:35,match:(e,t)=>e===t}},vf=Math.PI*2;Object.assign(gf.zh,{configureBet:`自动轮盘与多注下注`,betTable:`选择筹码后可连续下多注`,betTableHint:`小球在外沿转动期间可追加、撤销或清空下注；小球开始向内滑落时停止下注。`,dragHint:`固定全景 · 固定步长物理求解 · 外沿阶段开放下注`,readyToLaunch:`即将自动发球`,currentBets:`本局下注`,multiBetTitle:`多注清单`,undoBet:`撤销一步`,clearBets:`清空`,totalCurrentBet:`本局总注`,availableBankroll:`可用资金`,repeatLastBets:`重复上一局下注`,noBetsYet:`尚未下注。选择筹码后点击多个号码或外围区域。`,removeBet:`移除`,selectedChip:`当前筹码`,roundMode:`运行方式`,autoRounds:`自动连续开局`,pauseAfterRound:`本局后暂停`,resumeAuto:`继续自动开局`,paused:`自动轮盘已暂停`,pausePending:`本局开奖后暂停`,resultHold:`等待下一局自动发球`,bettingNotOpen:`当前不能下注，请等待下一局外沿倒计时。`,noPreviousBets:`没有可重复的上一局下注。`,noBatchBets:`请先完成至少一局下注，再使用批量模拟。`,batchRun:`按上一局下注批量模拟`,netWin:`本局净赢`,netLoss:`本局净亏`,watchedOnly:`本局未下注`,push:`持平`,resetWait:`请等待本局开奖后再重置。`,wheelChangePaused:`请先暂停自动轮盘再切换轮盘类型。`,expectedLossBet:`本局预计损失`,spinning:`小球已自动发出，外沿倒计时内可自由下注。`}),Object.assign(gf.en,{configureBet:`Automatic table and multiple bets`,betTable:`Choose a chip, then place multiple bets`,betTableHint:`Add, undo or clear bets while the ball circles the outer track. Betting closes as it begins to descend.`,dragHint:`Fixed camera · Fixed-step physics · Bet during the outer-track phase`,readyToLaunch:`Automatic launch shortly`,currentBets:`Current round`,multiBetTitle:`Multiple-bet slip`,undoBet:`Undo chip`,clearBets:`Clear`,totalCurrentBet:`Total bet`,availableBankroll:`Available bankroll`,repeatLastBets:`Repeat previous bets`,noBetsYet:`No bets yet. Choose a chip and click several numbers or outside areas.`,removeBet:`Remove`,selectedChip:`Selected chip`,roundMode:`Round mode`,autoRounds:`Continuous automatic rounds`,pauseAfterRound:`Pause after round`,resumeAuto:`Resume auto rounds`,paused:`Automatic table paused`,pausePending:`Will pause after this result`,resultHold:`Next ball launches automatically`,bettingNotOpen:`Betting is closed. Wait for the next outer-track countdown.`,noPreviousBets:`There are no previous bets to repeat.`,noBatchBets:`Complete at least one betting round before using batch simulation.`,batchRun:`Batch previous bets`,netWin:`Round net win`,netLoss:`Round net loss`,watchedOnly:`No bet this round`,push:`Break even`,resetWait:`Wait for the current result before resetting.`,wheelChangePaused:`Pause automatic rounds before changing wheel type.`,expectedLossBet:`Expected loss this round`,spinning:`The ball launched automatically. Betting remains open during the outer-track countdown.`}),Object.assign(gf.fr,{configureBet:`Table automatique et mises multiples`,betTable:`Choisissez un jeton puis placez plusieurs mises`,betTableHint:`Ajoutez, annulez ou effacez les mises pendant que la bille tourne sur la piste extérieure. Les mises ferment à la descente.`,dragHint:`Caméra fixe · Physique à pas fixe · Misez pendant la piste extérieure`,readyToLaunch:`Lancement automatique imminent`,currentBets:`Manche actuelle`,multiBetTitle:`Liste de mises multiples`,undoBet:`Annuler un jeton`,clearBets:`Effacer`,totalCurrentBet:`Mise totale`,availableBankroll:`Capital disponible`,repeatLastBets:`Répéter les mises précédentes`,noBetsYet:`Aucune mise. Choisissez un jeton et cliquez plusieurs numéros ou zones extérieures.`,removeBet:`Retirer`,selectedChip:`Jeton choisi`,roundMode:`Mode`,autoRounds:`Manches automatiques continues`,pauseAfterRound:`Pause après la manche`,resumeAuto:`Reprendre les manches`,paused:`Table automatique en pause`,pausePending:`Pause après ce résultat`,resultHold:`Prochain lancement automatique`,bettingNotOpen:`Les mises sont fermées. Attendez le prochain compte à rebours extérieur.`,noPreviousBets:`Aucune mise précédente à répéter.`,noBatchBets:`Terminez au moins une manche avec mise avant la simulation en lot.`,batchRun:`Simuler les mises précédentes`,netWin:`Gain net de la manche`,netLoss:`Perte nette de la manche`,watchedOnly:`Aucune mise cette manche`,push:`Équilibre`,resetWait:`Attendez le résultat actuel avant de réinitialiser.`,wheelChangePaused:`Mettez la table en pause avant de changer de roulette.`,expectedLossBet:`Perte prévue de la manche`,spinning:`La bille est lancée automatiquement. Les mises restent ouvertes pendant le compte à rebours extérieur.`}),Object.assign(gf.zh,{navPlay:`游戏`,navRules:`规则教学`,navLearn:`概率科普`,playPageTitle:`自动轮盘模拟`,inspectorBoard:`下注台`,inspectorSlip:`下注单`,inspectorStats:`数据`,needRules:`不懂规则？`,rulesKicker:`第一次玩也能看懂`,rulesPageTitle:`四步学会轮盘规则`,rulesPageIntro:`不需要背号码顺序。先理解下注区域、发球流程和赔率，再回到模拟器实践。`,lessonOneShort:`认识桌面`,lessonTwoShort:`开放下注`,lessonThreeShort:`停止下注`,lessonFourShort:`开奖结算`,lessonOneTitle:`先选择筹码，再点击下注区域`,lessonOneBody:`数字格属于内围下注；红黑、单双、大小、十二数和列属于外围下注。可同时押多个区域。`,lessonOnePointA:`单号命中率低、赔率高。`,lessonOnePointB:`红黑命中率接近一半、赔率为1:1。`,lessonOnePointC:`0和00不属于红黑、单双或大小。`,lessonTwoTitle:`发球后仍然可以下注`,lessonTwoBody:`自动桌先让转子逆时针旋转，再把小球沿固定外轨顺时针发出。外轨阶段显示倒计时，期间可追加、撤销或清空下注。`,phaseLaunch:`自动发球`,phaseOpen:`开放下注`,phaseClose:`停止下注`,phaseResult:`开奖`,lessonThreeTitle:`小球离开外轨时停止下注`,lessonThreeBody:`当球速下降、离心支撑减弱并开始向内滑落，下注立即锁定。之后只能等待球碰撞挡块并进入号码槽。`,lessonFourTitle:`按落袋号码结算所有下注`,lessonFourBody:`同一局可以有多笔下注。每笔分别判断是否覆盖最终号码，再按净赔率结算；没中的下注全部损失。`,exampleBet:`示例：10押红 + 5押17`,exampleResult:`结果17：两笔同时中奖`,previous:`上一步`,next:`下一步`,quickReference:`快速查表`,payoutReference:`常见下注与净赔率`,payoutReferenceNote:`赔率是净赢金额；中奖时本金会一并退回。`,coveredNumbers:`覆盖号码`,difficulty:`体验`,splitBet:`两个相邻号码`,streetBet:`一横排`,cornerBet:`四角`,dozenOrColumn:`十二数／列`,evenMoneyBet:`红黑／单双／大小`,highVariance:`波动极高`,mediumVariance:`波动较高`,balancedVariance:`中等波动`,lowVariance:`波动较低`,practiceNow:`回到游戏实践`,learnPageTitle:`为什么长期无法靠轮盘赢钱`,learnPageIntro:`赌场优势不保证你每局都输，但它让每一元累计下注都带有负期望。`,learnIndexEdge:`赌场优势`,learnIndexTurnover:`资金流水`,learnIndexFallacy:`赌徒谬误`,learnIndexCompare:`项目比较`,learnIndexResponsible:`负责任娱乐`,edgeSectionTitle:`赔率比公平赔率少一点，赌场就能长期盈利`,edgeSectionBody:`欧式轮盘有37个结果，但单号只赔35:1。红黑也不是50%，因为绿色0会让双方都输。`,redProbabilityNote:`欧式轮盘押红的真实中奖率`,physicsDisclosureTitle:`这次的球不是预设轨迹`,physicsDisclosure:`外轨与斜面阶段依据轮盘动力学方程，以每秒240步进行数值积分；挡板和号码隔片使用连续检测、碰撞冲量、摩擦与恢复系数计算。最终号码由球相对旋转转盘的实际稳定位置决定，不会预先抽号或强制对准。WebGL 不可用时才切换为2D均匀随机回退。`,returnToGame:`回到模拟器`}),Object.assign(gf.en,{navPlay:`Play`,navRules:`How to play`,navLearn:`Probability`,playPageTitle:`Automatic roulette table`,inspectorBoard:`Table`,inspectorSlip:`Bet slip`,inspectorStats:`Results`,needRules:`Need the rules?`,rulesKicker:`Clear enough for a first round`,rulesPageTitle:`Learn roulette in four steps`,rulesPageIntro:`You do not need to memorize the wheel order. Learn the betting areas, round flow, and payouts, then practise in the simulator.`,lessonOneShort:`Read the table`,lessonTwoShort:`Betting open`,lessonThreeShort:`Bets close`,lessonFourShort:`Settle bets`,lessonOneTitle:`Choose a chip, then select betting areas`,lessonOneBody:`Number squares are inside bets. Red/black, odd/even, high/low, dozens, and columns are outside bets. You may combine several bets.`,lessonOnePointA:`Straight-up numbers hit rarely and pay more.`,lessonOnePointB:`Red or black wins almost half the time and pays 1:1.`,lessonOnePointC:`0 and 00 are not red/black, odd/even, or high/low.`,lessonTwoTitle:`Betting stays open after launch`,lessonTwoBody:`The rotor turns counter-clockwise and the ball launches clockwise on the fixed outer track. During the countdown, you can add, undo, or clear bets.`,phaseLaunch:`Auto launch`,phaseOpen:`Betting open`,phaseClose:`No more bets`,phaseResult:`Result`,lessonThreeTitle:`Betting closes as the ball leaves the outer track`,lessonThreeBody:`As speed falls and centrifugal support weakens, the ball starts moving inward and all bets lock. It then meets the deflectors and pocket ring.`,lessonFourTitle:`Every bet settles against the final pocket`,lessonFourBody:`A round can contain several bets. Each bet is checked separately against the result and paid at its net odds; losing bets are removed.`,exampleBet:`Example: 10 on red + 5 on 17`,exampleResult:`Result 17: both bets win`,previous:`Previous`,next:`Next`,quickReference:`Quick reference`,payoutReference:`Common bets and net payouts`,payoutReferenceNote:`The payout is net profit; the original stake is also returned on a win.`,coveredNumbers:`Numbers covered`,difficulty:`Experience`,splitBet:`Two adjacent numbers`,streetBet:`One row of three`,cornerBet:`Four-number corner`,dozenOrColumn:`Dozen / column`,evenMoneyBet:`Red-black / odd-even / high-low`,highVariance:`Very high variance`,mediumVariance:`High variance`,balancedVariance:`Moderate variance`,lowVariance:`Lower variance`,practiceNow:`Practise in the game`,learnPageTitle:`Why roulette cannot produce reliable long-term profit`,learnPageIntro:`The house edge does not make every round a loss, but it gives every unit of cumulative wagering a negative expectation.`,learnIndexEdge:`House edge`,learnIndexTurnover:`Turnover`,learnIndexFallacy:`Gambler’s fallacy`,learnIndexCompare:`Game comparison`,learnIndexResponsible:`Responsible play`,edgeSectionTitle:`Pay slightly less than fair odds, and the house wins over time`,edgeSectionBody:`European roulette has 37 outcomes, but a straight-up number pays only 35:1. Red is not 50% either, because green 0 defeats both colours.`,redProbabilityNote:`True probability of red on a European wheel`,physicsDisclosureTitle:`The ball no longer follows a scripted path`,physicsDisclosure:`The rim and inclined-stator stages are numerically integrated at 240 fixed steps per second. Deflectors and pocket separators use swept collision checks, impulse response, friction, and restitution. The final number comes from the ball’s stable position relative to the rotating rotor; it is not preselected or force-aligned. Only the 2D fallback uses a uniform random result when WebGL is unavailable.`,returnToGame:`Return to simulator`}),Object.assign(gf.fr,{navPlay:`Jeu`,navRules:`Règles`,navLearn:`Probabilités`,playPageTitle:`Table de roulette automatique`,inspectorBoard:`Table`,inspectorSlip:`Mises`,inspectorStats:`Résultats`,needRules:`Besoin des règles ?`,rulesKicker:`Compréhensible dès la première partie`,rulesPageTitle:`Apprendre la roulette en quatre étapes`,rulesPageIntro:`Inutile de mémoriser l’ordre de la roue. Comprenez les zones de mise, le déroulement et les paiements, puis pratiquez dans le simulateur.`,lessonOneShort:`Lire la table`,lessonTwoShort:`Mises ouvertes`,lessonThreeShort:`Fin des mises`,lessonFourShort:`Règlement`,lessonOneTitle:`Choisissez un jeton puis une zone de mise`,lessonOneBody:`Les cases numérotées sont des mises intérieures. Rouge/noir, pair/impair, manque/passe, douzaines et colonnes sont des mises extérieures. Plusieurs mises peuvent être combinées.`,lessonOnePointA:`Un numéro plein gagne rarement mais paie davantage.`,lessonOnePointB:`Rouge ou noir gagne presque une fois sur deux et paie 1:1.`,lessonOnePointC:`0 et 00 ne sont ni rouge/noir, ni pair/impair, ni manque/passe.`,lessonTwoTitle:`Les mises restent ouvertes après le lancement`,lessonTwoBody:`Le rotor tourne dans le sens antihoraire et la bille part dans le sens horaire sur la piste extérieure fixe. Pendant le compte à rebours, on peut ajouter, annuler ou effacer des mises.`,phaseLaunch:`Lancement auto`,phaseOpen:`Mises ouvertes`,phaseClose:`Rien ne va plus`,phaseResult:`Résultat`,lessonThreeTitle:`Les mises ferment quand la bille quitte la piste`,lessonThreeBody:`Quand la vitesse baisse et que le soutien centrifuge diminue, la bille descend vers l’intérieur et toutes les mises sont verrouillées.`,lessonFourTitle:`Chaque mise est réglée selon la case finale`,lessonFourBody:`Une manche peut contenir plusieurs mises. Chacune est vérifiée séparément et payée selon sa cote nette; les mises perdantes sont retirées.`,exampleBet:`Exemple : 10 sur rouge + 5 sur 17`,exampleResult:`Résultat 17 : les deux mises gagnent`,previous:`Précédent`,next:`Suivant`,quickReference:`Référence rapide`,payoutReference:`Mises courantes et paiements nets`,payoutReferenceNote:`Le paiement est le bénéfice net; la mise initiale est aussi rendue en cas de gain.`,coveredNumbers:`Numéros couverts`,difficulty:`Expérience`,splitBet:`Deux numéros voisins`,streetBet:`Rangée de trois`,cornerBet:`Carré de quatre`,dozenOrColumn:`Douzaine / colonne`,evenMoneyBet:`Rouge-noir / pair-impair / manque-passe`,highVariance:`Variance très forte`,mediumVariance:`Variance forte`,balancedVariance:`Variance moyenne`,lowVariance:`Variance plus faible`,practiceNow:`Pratiquer dans le jeu`,learnPageTitle:`Pourquoi la roulette ne peut pas assurer un profit durable`,learnPageIntro:`L’avantage de la maison ne fait pas perdre chaque manche, mais donne une espérance négative à chaque unité rejouée.`,learnIndexEdge:`Avantage maison`,learnIndexTurnover:`Volume de mises`,learnIndexFallacy:`Erreur du joueur`,learnIndexCompare:`Comparaison`,learnIndexResponsible:`Jeu responsable`,edgeSectionTitle:`Un paiement légèrement inférieur à la cote juste suffit à la maison`,edgeSectionBody:`La roulette européenne compte 37 résultats, mais un numéro plein ne paie que 35:1. Rouge n’est pas à 50 %, car le 0 vert fait perdre les deux couleurs.`,redProbabilityNote:`Probabilité réelle du rouge sur une roue européenne`,physicsDisclosureTitle:`La bille ne suit plus une trajectoire programmée`,physicsDisclosure:`Les phases sur la piste et le stator incliné sont intégrées à 240 pas fixes par seconde. Les déflecteurs et séparateurs utilisent une détection balayée, des impulsions de collision, le frottement et la restitution. Le numéro final vient de la position stable de la bille par rapport au rotor en mouvement; il n’est ni présélectionné ni forcé. Seul le mode 2D de secours utilise un résultat aléatoire uniforme lorsque WebGL est indisponible.`,returnToGame:`Retour au simulateur`}),Object.assign(gf.zh,{coachLabel:`实时概率提示`,coachLearn:`查看原理`,chapterIndex:`章节目录`,learnPageTitle:`轮盘不是预测题，而是一门负期望实验`,learnPageIntro:`从赔率、独立事件、下注系统到破产风险，用可操作的小实验解释为什么“看起来有道理”的策略仍然无法改变长期数学期望。`,learnIndexEdge:`赔率与赌场优势`,learnIndexFallacy:`连开与独立事件`,learnIndexStrategies:`下注策略解剖`,learnIndexTurnover:`流水与时间`,learnIndexCompare:`项目比较`,learnIndexResponsible:`止损与边界`,chapterEdgeKicker:`公平赔率与实际赔率之间的一格空隙`,edgeSectionTitle:`赌场不需要操纵结果，只需要少赔一点`,edgeLead:`欧式轮盘的37个格子若完全等概率，单号的公平净赔率应是36:1；赌场只赔35:1。少掉的那一倍，就是每一元下注上的长期优势。`,edgeQuote:`赌场优势不是“每局都会收走2.7%”，而是大量重复下注后，每100元流水平均留下约2.70元。`,changesLabel:`它改变了什么`,notChangesLabel:`它没有改变什么`,edgeChanges:`长期平均回报`,edgeNotChanges:`单局仍可能大赢`,chapterStreakKicker:`把随机波动误认成趋势，是最常见的错觉`,fallacyLead:`每次合规轮盘转动都近似独立。前面出现多少次红，并不会改变下一次红、黑或绿色0的结构性概率。`,remember:`记住`,independenceNote:`历史结果可以描述过去，不能给下一颗球增加记忆。`,streakLabRun:`随机生成20次，看看连开有多常见`,chapterStrategyKicker:`策略改变下注路径，不改变轮盘赔率`,strategySectionTitle:`六种常见下注系统，逐个拆开看`,strategyFlat:`固定下注`,strategyMartingale:`马丁格尔`,strategyFibonacci:`斐波那契`,strategyDalembert:`达朗贝尔`,strategyLabouchere:`拉布谢尔`,strategyHotCold:`冷热号`,baseBet:`基础下注`,lossStreak:`连续失利次数`,nextBet:`下一注`,bankrollRequired:`累计所需资金`,strategyQuestionOne:`为什么经常“小赢”？`,strategyAnswerOne:`因为多数策略把大量常见的小利润放在前面，把罕见但巨大的亏损推迟到长连败时出现。`,strategyQuestionTwo:`为什么回测看起来有效？`,strategyAnswerTwo:`如果样本没有覆盖足够长的极端连败，策略的尾部风险就不会显现。`,strategyQuestionThree:`能否靠停赢止损修复？`,strategyAnswerThree:`它能限制单次会话的损失或时间，但不能把负期望变成正期望。`,chapterTurnoverKicker:`本金不是流水，慢一点比换策略更有效`,stakePerRound:`每局下注`,roundCount:`局数`,totalTurnover:`累计流水`,expectedLoss:`长期预计损失`,turnoverCaption:`同一笔筹码被反复赢回、再次下注，就会把100元本金滚成数千元流水。`,lowEdgeNotEnough:`低赌场优势不代表每小时一定亏得少`,speedMatters:`下注速度 × 每局金额同样重要`,chapterCompareKicker:`把“容易玩”和“损失比例”分开比较`,chapterResponsibleKicker:`唯一真正有效的是事前边界`,responsibleLead:`止损不会改善每一注的赔率，但能阻止一次娱乐会话演变成不可承受的损失。`,sessionBudget:`本次娱乐预算`,sessionLossLimit:`停止损失`,sessionTimeLimit:`停止时间（分钟）`}),Object.assign(gf.en,{coachLabel:`Live probability note`,coachLearn:`See the principle`,chapterIndex:`Chapter index`,learnPageTitle:`Roulette is not a prediction puzzle. It is a negative-expectation experiment.`,learnPageIntro:`Use small interactive experiments to examine payouts, independent events, betting systems, turnover, and ruin risk—and see why plausible systems cannot change long-run expected value.`,learnIndexEdge:`Payouts & house edge`,learnIndexFallacy:`Streaks & independence`,learnIndexStrategies:`Betting systems`,learnIndexTurnover:`Turnover & time`,learnIndexCompare:`Game comparison`,learnIndexResponsible:`Limits & boundaries`,chapterEdgeKicker:`The one-pocket gap between fair and paid odds`,edgeSectionTitle:`The house does not need to rig outcomes; it only needs to pay slightly less`,edgeLead:`With 37 equally likely pockets, the fair net payout for a straight-up European bet would be 36:1. The table pays 35:1. That missing unit creates the long-run edge on every unit wagered.`,edgeQuote:`A 2.70% house edge does not mean 2.70% is taken every round. It means that across large wagering turnover, the house keeps about 2.70 per 100 wagered on average.`,changesLabel:`What it changes`,notChangesLabel:`What it does not change`,edgeChanges:`Long-run average return`,edgeNotChanges:`A single round can still win big`,chapterStreakKicker:`Mistaking random variation for a trend is the most common illusion`,fallacyLead:`Each compliant roulette spin is approximately independent. A run of reds does not change the structural probabilities of red, black, or green on the next spin.`,remember:`Remember`,independenceNote:`History describes the past; it does not give the next ball a memory.`,streakLabRun:`Generate 20 spins and see how naturally streaks appear`,chapterStrategyKicker:`Systems change the path of bets, not the wheel payouts`,strategySectionTitle:`Six common betting systems, taken apart`,strategyFlat:`Flat betting`,strategyMartingale:`Martingale`,strategyFibonacci:`Fibonacci`,strategyDalembert:`D’Alembert`,strategyLabouchere:`Labouchère`,strategyHotCold:`Hot & cold numbers`,baseBet:`Base bet`,lossStreak:`Consecutive losses`,nextBet:`Next bet`,bankrollRequired:`Total bankroll required`,strategyQuestionOne:`Why do systems often show small wins?`,strategyAnswerOne:`Many systems put frequent small profits first while postponing rare, very large losses until a long losing streak.`,strategyQuestionTwo:`Why can backtests look convincing?`,strategyAnswerTwo:`If the sample never includes a sufficiently extreme losing run, the tail risk remains invisible.`,strategyQuestionThree:`Do win and loss limits repair the edge?`,strategyAnswerThree:`They can limit one session’s time or loss, but they cannot convert negative expectation into positive expectation.`,chapterTurnoverKicker:`Bankroll is not turnover; slowing down often matters more than switching systems`,stakePerRound:`Bet per round`,roundCount:`Rounds`,totalTurnover:`Total turnover`,expectedLoss:`Long-run expected loss`,turnoverCaption:`The same chips can be returned and wagered again, turning a 100 bankroll into thousands of wagering turnover.`,lowEdgeNotEnough:`A low house edge does not guarantee a low hourly loss`,speedMatters:`Betting speed × stake per round also matters`,chapterCompareKicker:`Compare ease of play separately from loss rate`,chapterResponsibleKicker:`The only reliable protection is a boundary set in advance`,responsibleLead:`A stop limit does not improve the payout of any bet, but it can keep an entertainment session from becoming an unaffordable loss.`,sessionBudget:`Entertainment budget`,sessionLossLimit:`Stop-loss amount`,sessionTimeLimit:`Stop time (minutes)`}),Object.assign(gf.fr,{coachLabel:`Note de probabilité en direct`,coachLearn:`Voir le principe`,chapterIndex:`Sommaire`,learnPageTitle:`La roulette n’est pas un problème de prédiction, mais une expérience à espérance négative`,learnPageIntro:`De petites expériences interactives expliquent les paiements, l’indépendance, les systèmes de mise, le volume joué et le risque de ruine.`,learnIndexEdge:`Paiements et avantage`,learnIndexFallacy:`Séries et indépendance`,learnIndexStrategies:`Systèmes de mise`,learnIndexTurnover:`Volume et temps`,learnIndexCompare:`Comparaison`,learnIndexResponsible:`Limites`,chapterEdgeKicker:`L’écart entre la cote juste et la cote payée`,edgeSectionTitle:`La maison n’a pas besoin de truquer le résultat; elle paie simplement un peu moins`,edgeLead:`Avec 37 cases équiprobables, la cote nette juste d’un numéro plein serait 36:1. La table paie 35:1. Cette unité manquante crée l’avantage à long terme.`,edgeQuote:`Un avantage de 2,70 % ne signifie pas une perte de 2,70 % à chaque tour, mais environ 2,70 conservés par la maison pour 100 misés sur un grand volume.`,changesLabel:`Ce que cela change`,notChangesLabel:`Ce que cela ne change pas`,edgeChanges:`Le rendement moyen à long terme`,edgeNotChanges:`Un tour peut toujours rapporter gros`,chapterStreakKicker:`Confondre variation aléatoire et tendance est l’illusion la plus fréquente`,fallacyLead:`Chaque tour conforme est approximativement indépendant. Une série de rouges ne modifie pas les probabilités du tour suivant.`,remember:`À retenir`,independenceNote:`L’historique décrit le passé; il ne donne aucune mémoire à la prochaine bille.`,streakLabRun:`Générer 20 tours et observer la fréquence naturelle des séries`,chapterStrategyKicker:`Les systèmes modifient le chemin des mises, pas les cotes`,strategySectionTitle:`Six systèmes de mise courants, démontés`,strategyFlat:`Mise fixe`,strategyMartingale:`Martingale`,strategyFibonacci:`Fibonacci`,strategyDalembert:`D’Alembert`,strategyLabouchere:`Labouchère`,strategyHotCold:`Numéros chauds/froids`,baseBet:`Mise de base`,lossStreak:`Pertes consécutives`,nextBet:`Mise suivante`,bankrollRequired:`Capital cumulé requis`,strategyQuestionOne:`Pourquoi tant de petits gains ?`,strategyAnswerOne:`Beaucoup de systèmes placent des gains fréquents au début et repoussent une perte rare mais énorme à une longue série perdante.`,strategyQuestionTwo:`Pourquoi les tests historiques semblent-ils fonctionner ?`,strategyAnswerTwo:`Si l’échantillon ne contient pas une série de pertes extrême, le risque de queue reste invisible.`,strategyQuestionThree:`Les limites gain/perte réparent-elles l’avantage ?`,strategyAnswerThree:`Elles limitent une session, mais ne transforment pas une espérance négative en espérance positive.`,chapterTurnoverKicker:`Le capital n’est pas le volume; ralentir compte souvent davantage`,stakePerRound:`Mise par tour`,roundCount:`Tours`,totalTurnover:`Volume total`,expectedLoss:`Perte prévue à long terme`,turnoverCaption:`Les mêmes jetons peuvent être rendus puis rejoués, transformant 100 de capital en milliers de volume.`,lowEdgeNotEnough:`Un faible avantage ne garantit pas une faible perte horaire`,speedMatters:`Vitesse × mise par tour compte aussi`,chapterCompareKicker:`Comparer séparément simplicité et taux de perte`,chapterResponsibleKicker:`La seule protection fiable est une limite fixée à l’avance`,responsibleLead:`Une limite n’améliore pas les cotes, mais empêche une session de devenir une perte inabordable.`,sessionBudget:`Budget de loisir`,sessionLossLimit:`Perte maximale`,sessionTimeLimit:`Durée maximale (minutes)`}),Object.assign(gf.zh,{dragHint:`拖动调整角度 · 滚轮或双指缩放 · 点击号码下注`,cameraHint:`拖动 · 缩放`,pauseMenuKicker:`桌面已暂停`,pauseMenuTitle:`休息一下，再决定是否继续`,pauseMenuBody:`可以继续自动开局、重置资金与统计，或调整视角和声音。`,resumeGame:`继续游戏`,resetSession:`重置本次模拟`,resetView:`恢复默认视角`,soundAndAtmosphere:`声音与现场氛围`,soundPrivacy:`声音由浏览器本地合成，不加载外部音乐。`,soundEffectsNote:`小球、挡板与开奖提示音`,casinoAmbience:`赌场环境声`,casinoAmbienceNote:`轻柔人群底噪、筹码声与原创休闲乐垫`,masterVolume:`总音量`,pauseFootnote:`重置只影响本地模拟数据，不会刷新页面或上传任何信息。`,cameraResetDone:`已恢复默认视角。`,audioUnlockHint:`首次点击页面后将启用浏览器本地合成的环境声。`}),Object.assign(gf.en,{dragHint:`Drag to orbit · Wheel or pinch to zoom · Click a pocket to bet`,cameraHint:`Drag · Zoom`,pauseMenuKicker:`Table paused`,pauseMenuTitle:`Take a break before deciding what comes next`,pauseMenuBody:`Resume automatic rounds, reset the local session, or adjust the camera and sound.`,resumeGame:`Resume game`,resetSession:`Reset this simulation`,resetView:`Restore default view`,soundAndAtmosphere:`Sound and atmosphere`,soundPrivacy:`Audio is generated locally in the browser; no external music is loaded.`,soundEffectsNote:`Ball, deflector, and result sounds`,casinoAmbience:`Casino ambience`,casinoAmbienceNote:`Soft room murmur, distant chips, and an original lounge pad`,masterVolume:`Master volume`,pauseFootnote:`Resetting only clears local simulation data. It does not refresh the page or upload information.`,cameraResetDone:`Default camera restored.`,audioUnlockHint:`Locally generated ambience starts after the first page interaction.`}),Object.assign(gf.fr,{dragHint:`Glisser pour tourner · Molette ou pincement pour zoomer · Cliquer une case pour miser`,cameraHint:`Glisser · Zoomer`,pauseMenuKicker:`Table en pause`,pauseMenuTitle:`Faites une pause avant de décider de continuer`,pauseMenuBody:`Reprenez les manches, réinitialisez la session locale ou ajustez la caméra et le son.`,resumeGame:`Reprendre le jeu`,resetSession:`Réinitialiser cette simulation`,resetView:`Rétablir la vue par défaut`,soundAndAtmosphere:`Son et ambiance`,soundPrivacy:`Le son est généré localement dans le navigateur; aucune musique externe n’est chargée.`,soundEffectsNote:`Bille, déflecteurs et résultat`,casinoAmbience:`Ambiance de casino`,casinoAmbienceNote:`Murmure discret, jetons lointains et nappe lounge originale`,masterVolume:`Volume général`,pauseFootnote:`La réinitialisation efface seulement les données locales de simulation sans recharger la page ni envoyer de données.`,cameraResetDone:`Vue par défaut rétablie.`,audioUnlockHint:`L’ambiance locale démarre après la première interaction avec la page.`});var yf={zh:{flat:{name:`固定下注`,verdict:`最透明，但仍是负期望`,description:`每局下注相同金额。它不会制造“追回损失”的错觉，因此资金曲线更容易理解；长期平均损失仍等于流水乘赌场优势。`,changes:`降低下注额升级带来的尾部风险，波动相对可控。`,notChanges:`每一元下注的负数学期望。`},martingale:{name:`马丁格尔`,verdict:`高概率小赢，低概率重伤`,description:`每输一次把下一注翻倍，赢一次后回到基础下注。一次胜利可以覆盖此前损失并多赢一份基础注，但长连败会让下注额指数增长。`,changes:`盈亏分布：更多小赢，少数极大亏损。`,notChanges:`红黑中奖概率、赌场优势和长期期望。`},fibonacci:{name:`斐波那契`,verdict:`增长较慢，不代表安全`,description:`按1、1、2、3、5、8…递增。它比翻倍温和，却仍会在长连败中持续扩大资金暴露，而且一次胜利通常不能立即覆盖全部损失。`,changes:`下注增长速度与回本路径。`,notChanges:`轮盘结果的独立性和负期望。`},dalembert:{name:`达朗贝尔`,verdict:`线性加码，风险只是来得更慢`,description:`输一次增加一个基础单位，赢一次减少一个单位。它建立在“输赢会趋向平衡”的直觉上，但短期序列没有义务及时均衡。`,changes:`下注额以线性而非指数方式变化。`,notChanges:`下一局概率，也不能保证均值回归在资金耗尽前发生。`},labouchere:{name:`拉布谢尔`,verdict:`看似有计划，实质仍在追损`,description:`先写下一串数字，下注首尾之和；赢则划掉首尾，输则把刚才下注额加到末尾。连败会让清单和下注额一起膨胀。`,changes:`用“清单完成”包装资金递进。`,notChanges:`每次下注的期望值与尾部破产风险。`},hotcold:{name:`冷热号`,verdict:`描述过去，不预测未来`,description:`根据近期频率追“热号”或反买“冷号”。热手和赌徒谬误方向相反，却都把随机波动当作可延续或可反转的信号。`,changes:`选号方式与故事感。`,notChanges:`每个合法号码下一局被抽中的概率。`}},en:{flat:{name:`Flat betting`,verdict:`Transparent, but still negative expectation`,description:`Wager the same amount every round. The bankroll path is easier to understand because there is no recovery escalation, but expected loss remains turnover multiplied by house edge.`,changes:`Removes progression tail risk and keeps variance more legible.`,notChanges:`The negative expectation on every unit wagered.`},martingale:{name:`Martingale`,verdict:`Frequent small wins, rare severe damage`,description:`Double after every loss and reset after a win. One win recovers earlier losses plus one base unit, but a long losing run makes the stake grow exponentially.`,changes:`The shape of outcomes: many small wins and a few enormous losses.`,notChanges:`Win probability, house edge, or long-run expected value.`},fibonacci:{name:`Fibonacci`,verdict:`Slower growth is not safety`,description:`Move through 1, 1, 2, 3, 5, 8… after losses. It escalates more gently than doubling, but exposure still grows and one win may not recover the full sequence.`,changes:`Escalation speed and the route back toward break-even.`,notChanges:`Independence of spins and negative expectation.`},dalembert:{name:`D’Alembert`,verdict:`Linear escalation only delays the risk`,description:`Add one base unit after a loss and subtract one after a win. It relies on the intuition that wins and losses will soon balance, but short sequences have no duty to rebalance in time.`,changes:`Stake size grows linearly rather than exponentially.`,notChanges:`Next-spin probability or whether mean reversion arrives before ruin.`},labouchere:{name:`Labouchère`,verdict:`A plan-shaped form of loss chasing`,description:`Write a number line, bet the sum of its first and last entries, cross them off after a win, and append the lost amount after a loss. Losing runs expand both the list and the stake.`,changes:`Packages progression as completion of a cancellation list.`,notChanges:`Expected value per wager and tail ruin risk.`},hotcold:{name:`Hot & cold numbers`,verdict:`Describes the past, not the next spin`,description:`Follow frequent “hot” outcomes or oppose overdue “cold” outcomes. Hot-hand and gambler’s-fallacy stories point in opposite directions but both treat random variation as a signal.`,changes:`Selection method and narrative appeal.`,notChanges:`The probability that each legal pocket appears next.`}},fr:{flat:{name:`Mise fixe`,verdict:`Claire, mais toujours à espérance négative`,description:`La même somme est misée à chaque tour. La trajectoire est plus lisible sans escalade, mais la perte prévue reste le volume multiplié par l’avantage.`,changes:`Réduit le risque de queue des progressions.`,notChanges:`L’espérance négative de chaque unité misée.`},martingale:{name:`Martingale`,verdict:`Petits gains fréquents, rare perte sévère`,description:`Doubler après chaque perte et revenir à la base après un gain. Un gain récupère la série, mais une longue série perdante fait croître la mise exponentiellement.`,changes:`La forme des résultats.`,notChanges:`Probabilité, avantage maison et espérance.`},fibonacci:{name:`Fibonacci`,verdict:`Une croissance plus lente n’est pas une sécurité`,description:`Suivre 1, 1, 2, 3, 5, 8… après les pertes. L’exposition augmente toujours et un gain ne récupère pas nécessairement toute la série.`,changes:`La vitesse de progression.`,notChanges:`L’indépendance et l’espérance négative.`},dalembert:{name:`D’Alembert`,verdict:`La progression linéaire retarde seulement le risque`,description:`Ajouter une unité après une perte et en retirer une après un gain. Rien n’oblige une courte série à se rééquilibrer avant l’épuisement du capital.`,changes:`Une croissance linéaire de la mise.`,notChanges:`La probabilité du prochain tour.`},labouchere:{name:`Labouchère`,verdict:`Une poursuite des pertes présentée comme un plan`,description:`Miser la somme du premier et du dernier nombre, les rayer après un gain et ajouter la perte à la fin. Les séries perdantes gonflent liste et mise.`,changes:`La forme de la progression.`,notChanges:`L’espérance par mise et le risque de ruine.`},hotcold:{name:`Numéros chauds/froids`,verdict:`Décrit le passé, pas le prochain tour`,description:`Suivre les résultats fréquents ou contrer ceux jugés en retard. Les deux récits donnent à la variation aléatoire un pouvoir prédictif absent.`,changes:`La méthode de sélection.`,notChanges:`La probabilité de chaque case au prochain tour.`}}},bf={zh:{due:{title:`黑色并没有“该出了”`,body:`连续出现同色不会改变下一局概率。你正在用赌徒谬误解释一个独立事件。`,topic:`streaks`},hot:{title:`连红也不代表红色正在变热`,body:`追随同色连开属于热手错觉。历史序列不会提高下一颗球重复同色的概率。`,topic:`streaks`},martingale:{title:`你正在放大追损下注`,body:`输后大幅提高下注额会把许多小结果换成一次可能很大的亏损，但不会改变赌场优势。`,topic:`strategies`},hedge:{title:`同时押红黑不是无风险覆盖`,body:`0（以及美式轮盘的00）仍会让两边一起输，而且资金被占用后长期期望仍为负。`,topic:`edge`},turnover:{title:`你的累计流水已经超过初始资金数倍`,body:`长期预计损失由流水而不是最初带入金额决定。降低局速和单注更直接。`,topic:`turnover`},variance:{title:`短期赢钱不等于找到了规律`,body:`负期望游戏仍会自然产生赢家。需要比较大量重复结果与理论期望，而不是只看几局。`,topic:`turnover`},doublezero:{title:`双零把赌场优势几乎翻倍`,body:`美式轮盘的0与00都击败常见1:1下注，典型赌场优势从2.70%升到5.26%。`,topic:`edge`}},en:{due:{title:`Black is not “due”`,body:`A same-colour streak does not change the next-spin probability. This is the gambler’s fallacy applied to an independent event.`,topic:`streaks`},hot:{title:`A red streak does not make red hotter`,body:`Following a colour streak is a hot-hand story. History does not increase the probability of another same-colour result.`,topic:`streaks`},martingale:{title:`Your loss-chasing stake is escalating`,body:`A large increase after a loss trades many small outcomes for a possible severe loss without changing the house edge.`,topic:`strategies`},hedge:{title:`Betting both red and black is not risk-free coverage`,body:`0—and 00 on an American wheel—still defeats both sides, while the combined wager retains negative expectation.`,topic:`edge`},turnover:{title:`Turnover now exceeds your starting bankroll several times`,body:`Expected loss is driven by total wagering turnover. Slower rounds and smaller stakes are more direct controls.`,topic:`turnover`},variance:{title:`A short-term win is not evidence of a system`,body:`Negative-expectation games naturally produce winners. Compare many repetitions with theoretical expectation, not a few rounds.`,topic:`turnover`},doublezero:{title:`Double zero nearly doubles the house edge`,body:`Both 0 and 00 defeat standard even-money bets, raising the typical edge from 2.70% to 5.26%.`,topic:`edge`}},fr:{due:{title:`Le noir n’est pas « dû »`,body:`Une série de même couleur ne change pas la probabilité suivante. C’est l’erreur du joueur appliquée à un événement indépendant.`,topic:`streaks`},hot:{title:`Une série rouge ne rend pas le rouge plus chaud`,body:`Suivre une série est une illusion de main chaude. L’historique n’augmente pas la chance de répétition.`,topic:`streaks`},martingale:{title:`La mise de poursuite augmente`,body:`Augmenter fortement après une perte échange de petits résultats contre une perte potentiellement sévère sans changer l’avantage.`,topic:`strategies`},hedge:{title:`Miser rouge et noir n’est pas une couverture sans risque`,body:`Le 0—et le 00 en américaine—fait perdre les deux côtés et l’espérance reste négative.`,topic:`edge`},turnover:{title:`Le volume joué dépasse plusieurs fois le capital initial`,body:`La perte prévue dépend du volume total. Ralentir et réduire la mise sont les contrôles les plus directs.`,topic:`turnover`},variance:{title:`Un gain court ne prouve aucun système`,body:`Un jeu à espérance négative produit naturellement des gagnants. Il faut comparer de nombreuses répétitions à la théorie.`,topic:`turnover`},doublezero:{title:`Le double zéro double presque l’avantage`,body:`0 et 00 battent les mises simples, faisant passer l’avantage typique de 2,70 % à 5,26 %.`,topic:`edge`}}},X=Object.fromEntries([...document.querySelectorAll(`[id]`)].map(e=>[e.id,e])),Z=X.wheelCanvas.getContext(`2d`),xf=X.profitChart.getContext(`2d`),Sf=localStorage.getItem(`rouletteLabLanguage`)||`zh`,Cf=10,wf=`idle`,Tf=!1,Ef=!0,Df=!1,Of=new Map,kf=[],Af=[],jf=[],Q=zf(),Mf=null,Nf=0,Pf=`edge`,Ff=`flat`,If={kind:null,topic:`streaks`,hidden:!0,lastShownSpin:-99},Lf=!1,Rf={sfx:localStorage.getItem(`rouletteLabSfx`)!==`false`,ambience:localStorage.getItem(`rouletteLabAmbience`)!==`false`,volume:Math.max(0,Math.min(1,Number(localStorage.getItem(`rouletteLabVolume`)??.62)))};function zf(){let e=Math.max(1,Number(X.startingBankroll?.value||1e3));return{startingBankroll:e,bankroll:e,spins:0,wagered:0,returned:0,history:[],chart:[{x:0,actual:0,expected:0}]}}function $(e){return gf[Sf][e]??e}function Bf(){return X.wheelType.value===`american`?mf:pf}function Vf(){return X.wheelType.value===`american`?2/38:1/37}function Hf(e){return e===`0`||e===`00`?`green`:hf.has(e)?`red`:`black`}function Uf(e,t=``){return`${e}:${t??``}`}function Wf(e){return e.map(e=>({...e}))}function Gf(){return[...Of.values()].reduce((e,t)=>e+t.amount,0)}function Kf(e){return e.reduce((e,t)=>e+t.amount,0)}function qf(e){return new Promise(t=>window.setTimeout(t,e))}function Jf(e){if(!Number.isInteger(e)||e<=0)throw Error(`Invalid max`);let t=4294967296,n=t-t%e,r=new Uint32Array(1),i;do crypto.getRandomValues(r),i=r[0];while(i>=n);return i%e}function Yf(){let e=Bf();return e[Jf(e.length)]}function Xf(e){let t=gf[Sf].locale,n=Sf===`zh`?`CNY`:`CAD`;return new Intl.NumberFormat(t,{style:`currency`,currency:n,maximumFractionDigits:2}).format(e)}function Zf(e,t=2){return new Intl.NumberFormat(gf[Sf].locale,{style:`percent`,maximumFractionDigits:t}).format(e)}function Qf(e){return new Intl.NumberFormat(gf[Sf].locale).format(e)}function $f(e){return`${e>0?`+`:``}${Xf(e)}`}function ep(e){return e.type===`straight`?`${$(`betStraight`)} ${e.selected}`:$(_f[e.type]?.label||e.type)}function tp(e=``){X.statusMessage.textContent=e}function np(){localStorage.setItem(`rouletteLabSfx`,String(Rf.sfx)),localStorage.setItem(`rouletteLabAmbience`,String(Rf.ambience)),localStorage.setItem(`rouletteLabVolume`,String(Rf.volume))}function rp(){X.soundToggle&&(X.soundToggle.checked=Rf.sfx),X.pauseSfxToggle&&(X.pauseSfxToggle.checked=Rf.sfx),X.ambienceToggle&&(X.ambienceToggle.checked=Rf.ambience),X.masterVolume&&(X.masterVolume.value=String(Math.round(Rf.volume*100))),X.masterVolumeValue&&(X.masterVolumeValue.value=`${Math.round(Rf.volume*100)}%`)}function ip({unlock:e=!1}={}){if(rp(),!Mf)return;let t=document.body.dataset.view===`play`;Mf.setSound(t&&Rf.sfx),Mf.setAmbience(t&&Rf.ambience),Mf.setMasterVolume(Rf.volume),e&&Mf.unlockAudio().catch(()=>{}),np()}function ap({focus:e=!0}={}){!X.pauseOverlay||document.body.dataset.view!==`play`||(Lf=!0,X.pauseOverlay.hidden=!1,document.body.classList.add(`pause-menu-open`),requestAnimationFrame(()=>X.pauseOverlay.classList.add(`is-visible`)),e&&window.setTimeout(()=>X.resumeButton?.focus(),80))}function op(){X.pauseOverlay&&(Lf=!1,X.pauseOverlay.classList.remove(`is-visible`),document.body.classList.remove(`pause-menu-open`),window.setTimeout(()=>{Lf||(X.pauseOverlay.hidden=!0)},220))}function sp(){Mf?.resetCamera(),tp($(`cameraResetDone`))}function cp(){document.documentElement.lang=gf[Sf].locale,document.querySelectorAll(`[data-i18n]`).forEach(e=>{let t=gf[Sf][e.dataset.i18n];t&&(e.textContent=t)}),up(),gp(),Mp(),jp(),Ap(),Np(),Pp(),Tp(),vp(wf),Wp(),Kp(),qp(),Zp(),rp(),localStorage.setItem(`rouletteLabLanguage`,Sf)}function lp({label:e,type:t,selected:n=``,className:r=``}){let i=Uf(t,n),a=document.createElement(`button`);a.type=`button`,a.className=`table-bet ${r}`.trim(),a.dataset.betKey=i,a.dataset.betType=t,a.dataset.selected=n;let o=document.createElement(`span`);o.className=`bet-label`,o.textContent=e,a.append(o);let s=Of.get(i);if(s){let e=document.createElement(`span`);e.className=`bet-marker`,e.textContent=Qf(s.amount),a.append(e),a.classList.add(`has-bet`)}return a.addEventListener(`click`,()=>dp(t,n)),a}function up(){if(!X.betBoard)return;X.betBoard.innerHTML=``;let e=document.createElement(`div`);e.className=`zero-rail`,e.append(lp({label:`0`,type:`straight`,selected:`0`,className:`number-bet number-green`})),X.wheelType.value===`american`&&e.append(lp({label:`00`,type:`straight`,selected:`00`,className:`number-bet number-green`}));let t=document.createElement(`div`);t.className=`number-bet-grid`;for(let e=0;e<12;e++)for(let n=1;n<=3;n++){let r=String(e*3+n);t.append(lp({label:r,type:`straight`,selected:r,className:`number-bet number-${Hf(r)}`}))}let n=document.createElement(`div`);n.className=`dozen-row`,[`dozen1`,`dozen2`,`dozen3`].forEach(e=>{n.append(lp({label:$(_f[e].label),type:e,className:`outside-bet`}))});let r=document.createElement(`div`);r.className=`outside-row`,[[`low`,`1–18`,``],[`even`,$(`betEven`),``],[`red`,$(`betRed`),`bet-red`],[`black`,$(`betBlack`),`bet-black`],[`odd`,$(`betOdd`),``],[`high`,`19–36`,``]].forEach(([e,t,n])=>r.append(lp({label:t,type:e,className:`outside-bet ${n}`})));let i=document.createElement(`div`);i.className=`column-row`,[`column1`,`column2`,`column3`].forEach(e=>{i.append(lp({label:$(_f[e].label),type:e,className:`outside-bet`}))});let a=document.createElement(`div`);a.className=`bet-board-main`,a.append(e,t),X.betBoard.append(a,n,r,i),_p(wf===`betting-open`)}function dp(e,t=``){if(wf!==`betting-open`){tp($(`bettingNotOpen`));return}if(!_f[e])return;if(Gf()+Cf>Q.bankroll){tp($(`insufficient`));return}let n=Uf(e,t),r=Of.get(n);r?r.amount+=Cf:Of.set(n,{key:n,type:e,selected:t,amount:Cf,payout:_f[e].payout}),kf.push({key:n,amount:Cf}),tp(``),gp(),up(),Qp(e)}function fp(){if(wf!==`betting-open`)return tp($(`bettingNotOpen`));let e=kf.pop();if(!e)return;let t=Of.get(e.key);t&&(t.amount-=e.amount,t.amount<=0&&Of.delete(e.key),gp(),up())}function pp(e){if(wf!==`betting-open`)return tp($(`bettingNotOpen`));Of.delete(e),kf=kf.filter(t=>t.key!==e),gp(),up()}function mp(){if(wf!==`betting-open`)return tp($(`bettingNotOpen`));Of.clear(),kf=[],gp(),up()}function hp(){if(wf!==`betting-open`)return tp($(`bettingNotOpen`));if(!jf.length)return tp($(`noPreviousBets`));if(Kf(jf)>Q.bankroll)return tp($(`insufficient`));Of=new Map(jf.map(e=>[e.key,{...e}])),kf=jf.flatMap(e=>[{key:e.key,amount:e.amount}]),tp(``),gp(),up()}function gp(){if(!X.betSlipList)return;X.betSlipList.innerHTML=``;let e=[...Of.values()];if(e.length)e.forEach(e=>{let t=document.createElement(`div`);t.className=`bet-slip-item`;let n=document.createElement(`span`);n.textContent=ep(e);let r=document.createElement(`strong`);r.textContent=Xf(e.amount);let i=document.createElement(`button`);i.type=`button`,i.textContent=`×`,i.title=$(`removeBet`),i.setAttribute(`aria-label`,`${$(`removeBet`)} ${ep(e)}`),i.disabled=wf!==`betting-open`,i.addEventListener(`click`,()=>pp(e.key)),t.append(n,r,i),X.betSlipList.append(t)});else{let e=document.createElement(`p`);e.className=`empty-bets`,e.textContent=$(`noBetsYet`),X.betSlipList.append(e)}let t=Gf();X.totalCurrentBet.textContent=Xf(t),document.querySelectorAll(`.mirror-total-current`).forEach(e=>{e.textContent=Xf(t)}),X.availableBankroll.textContent=Xf(Math.max(0,Q.bankroll-t)),X.edgeValue.textContent=Zf(Vf(),2),X.expectedLossValue.textContent=Xf(t*Vf()),X.selectedChipValue.textContent=Xf(Cf),X.undoBetButton.disabled=wf!==`betting-open`||!kf.length,X.clearBetsButton.disabled=wf!==`betting-open`||!e.length,X.repeatBetsButton.disabled=wf!==`betting-open`||!jf.length}function _p(e){document.querySelectorAll(`.table-bet`).forEach(t=>{t.disabled=!e}),X.betBoard?.classList.toggle(`is-locked`,!e),gp()}function vp(e,t=null){if(wf=e,!X.roundPhase)return;X.roundPhase.className=`round-phase is-${e}`;let n={idle:$(`readyToLaunch`),paused:$(`paused`),"betting-open":$(`bettingOpen`),"bets-closed":$(`noMoreBets`),descending:$(`descending`),settling:$(`settling`),resolved:$(`resultHold`)};X.roundPhaseLabel.textContent=n[e]||n.idle,e===`betting-open`&&Number.isFinite(t)?(X.roundPhaseLabel.textContent=$(`betsCloseIn`),X.roundCountdown.textContent=String(t)):e===`bets-closed`||e===`descending`?X.roundCountdown.textContent=`×`:X.roundCountdown.textContent=`—`,_p(e===`betting-open`)}function yp(e,t){let n=Kf(t);Q.spins+=1,Q.wagered+=n,Q.bankroll-=n;let r=0,i=0;for(let n of t){let t=_f[n.type];t?.match(e,n.selected)&&(r+=n.amount*(t.payout+1),i+=1)}Q.bankroll+=r,Q.returned+=r;let a=r-n,o=Q.bankroll-Q.startingBankroll,s=-Q.wagered*Vf();return Q.history.unshift({result:e,net:a,stake:n,winningBets:i}),Q.history=Q.history.slice(0,14),Q.chart.push({x:Q.spins,actual:o,expected:s}),{net:a,stake:n,returned:r,winningBets:i}}async function bp(e={}){if(Mf?.ready)return Mf.spin(e);let t=Yf(),n=Bf(),r=n.indexOf(t),i=vf/n.length,a=Nf,o=6500,s=performance.now(),c=!1,l=null;return e.onPhase?.({phase:`betting-open`}),new Promise(n=>{function u(d){let f=d-s;if(f<o){let t=Math.max(0,Math.ceil((o-f)/1e3));t!==l&&(l=t,e.onCountdown?.({seconds:t})),Nf=a+f*.0013}else{c||(c=!0,e.onBetsClosed?.({resultPending:!0}),e.onPhase?.({phase:`descending`}));let t=Lp((f-o)/2500),n=-r*i;Nf+=zp(Nf,n)*Math.min(1,.03+t*.1)}Np(Nf),f<9e3?requestAnimationFrame(u):(Nf=-r*i,Np(Nf),e.onPhase?.({phase:`settling`}),n(t))}requestAnimationFrame(u)})}function xp(){Of.clear(),kf=[],Af=[],gp(),up()}async function Sp(){if(Tf||!Ef)return;Tf=!0,xp(),X.wheelType.disabled=!0,X.startingBankroll.disabled=!0,X.batchButton.disabled=!0,tp($(`spinning`));let e=await bp({onCountdown:({seconds:e})=>{vp(`betting-open`,e),tp(`${$(`betsCloseIn`)}: ${e}`)},onBetsClosed:()=>{Af=Wf([...Of.values()]),vp(`bets-closed`),tp($(`noMoreBets`))},onPhase:({phase:e})=>{e===`betting-open`?vp(`betting-open`,9):e===`descending`?(vp(`descending`),tp($(`descending`))):e===`settling`&&(vp(`settling`),tp($(`settling`)))}});!Af.length&&Of.size&&(Af=Wf([...Of.values()]));let t=yp(e,Af);Af.length&&(jf=Wf(Af)),Op(e,t),$p(t),vp(`resolved`),Mf?.ready&&await Mf.resolveResult(t.net,e),Tf=!1,X.batchButton.disabled=!1,Ef?tp($(`resultHold`)):(X.wheelType.disabled=!1,X.startingBankroll.disabled=!1,vp(`paused`),tp($(`paused`)),ap()),Tp()}async function Cp(){if(!Df)for(Df=!0,await qf(900);;){if(!Ef||Tf){await qf(160);continue}await Sp(),Ef&&await qf(2400)}}function wp({showMenu:e=!0}={}){Ef=!Ef,Ef?(op(),X.wheelType.disabled=!0,X.startingBankroll.disabled=!0,tp($(`readyToLaunch`)),ip({unlock:!0}),Cp()):Tf?tp($(`pausePending`)):(vp(`paused`),X.wheelType.disabled=!1,X.startingBankroll.disabled=!1,tp($(`paused`)),e&&ap()),Tp()}function Tp(){X.pauseButton.textContent=$(Ef?`pauseAfterRound`:`resumeAuto`)}function Ep(){if(Tf)return;if(!jf.length)return tp($(`noBatchBets`));Ef=!1,Tp(),vp(`paused`);let e=Number(X.batchSize.value),t=Wf(jf),n=Kf(t),r=null,i=null,a=0;for(let o=0;o<e&&!(n>Q.bankroll);o++)r=Yf(),i=yp(r,t),a+=1;r&&(Mf?.setResult(r),Op(r,i)),tp($(a<e?`batchStopped`:`batchDone`)),X.wheelType.disabled=!1,X.startingBankroll.disabled=!1}function Dp(e=!0){if(Tf)return tp($(`resetWait`));Ef=!1,Xp(),If={kind:null,topic:`streaks`,hidden:!0,lastShownSpin:-99},Q=zf(),Of.clear(),kf=[],Af=[],jf=[],Nf=0,Mf?.reset(),X.resultBadge.textContent=`—`,X.resultBadge.className=`result-badge result-green`,X.lastResultText.textContent=`—`,X.lastOutcomeText.textContent=`—`,X.lastOutcomeText.className=``,X.cinematicResult.className=`cinematic-result`,vp(`paused`),Op(),up(),gp(),Tp(),X.wheelType.disabled=!1,X.startingBankroll.disabled=!1,e&&tp($(`resetDone`))}function Op(e=null,t=null){e!==null&&t&&kp(e,t),jp(),Mp(),Pp(),gp()}function kp(e,t){let n=Hf(e);X.resultBadge.textContent=e,X.resultBadge.className=`result-badge result-${n}`,X.lastResultText.textContent=e,t.stake===0?(X.lastOutcomeText.textContent=$(`watchedOnly`),X.lastOutcomeText.className=``):t.net>0?(X.lastOutcomeText.textContent=`${$(`netWin`)} ${$f(t.net)}`,X.lastOutcomeText.className=`outcome-win`):t.net<0?(X.lastOutcomeText.textContent=`${$(`netLoss`)} ${Xf(Math.abs(t.net))}`,X.lastOutcomeText.className=`outcome-loss`):(X.lastOutcomeText.textContent=$(`push`),X.lastOutcomeText.className=``);let r=t.stake===0?$(`watchedOnly`):t.net>0?$(`wonBanner`):t.net<0?$(`lostBanner`):$(`push`);X.cinematicResultLabel.textContent=r,X.cinematicResultNumber.textContent=e;let i=t.net>0?`is-win`:t.net<0?`is-loss`:`is-push`;X.cinematicResult.className=`cinematic-result is-visible ${i}`,window.clearTimeout(kp.timer),kp.timer=window.setTimeout(()=>{X.cinematicResult.className=`cinematic-result`},1900)}function Ap(){let e=Q.history[0];if(!e)return;let t={net:e.net,stake:e.stake};kp(e.result,t)}function jp(){X.historyStrip.innerHTML=``,Q.history.forEach(e=>{let t=document.createElement(`span`);t.className=`history-chip result-${Hf(e.result)}`,t.textContent=e.result,t.title=e.stake===0?$(`watchedOnly`):$f(e.net),X.historyStrip.append(t)})}function Mp(){X.bankrollMetric.textContent=Xf(Q.bankroll),X.spinsMetric.textContent=Qf(Q.spins),X.wageredMetric.textContent=Xf(Q.wagered),X.profitMetric.textContent=$f(Q.bankroll-Q.startingBankroll),X.expectedMetric.textContent=Xf(-Q.wagered*Vf()),X.returnMetric.textContent=Q.wagered>0?Zf(Q.returned/Q.wagered,2):`—`}function Np(e=Nf){let t=X.wheelCanvas,n=Math.min(window.devicePixelRatio||1,2),r=Math.max(300,t.getBoundingClientRect().width||610);t.width=Math.round(r*n),t.height=Math.round(r*n),Z.setTransform(n,0,0,n,0,0);let i=r,a=i/2,o=i*.46,s=i*.3,c=Bf(),l=vf/c.length;Z.clearRect(0,0,i,i),Z.save(),Z.translate(a,a),Z.beginPath(),Z.arc(0,0,o*1.06,0,vf),Z.fillStyle=`#8d5d24`,Z.fill(),Z.rotate(e),c.forEach((e,t)=>{let n=-Math.PI/2+t*l-l/2;Z.beginPath(),Z.arc(0,0,o,n,n+l),Z.arc(0,0,s,n+l,n,!0),Z.closePath(),Z.fillStyle=Hf(e)===`red`?`#b62635`:Hf(e)===`green`?`#087a50`:`#10151d`,Z.fill(),Z.strokeStyle=`#d6ab53`,Z.lineWidth=1,Z.stroke(),Z.save(),Z.rotate(n+l/2),Z.translate((o+s)/2,0),Z.rotate(Math.PI/2),Z.fillStyle=`#fff`,Z.font=`800 ${Math.max(10,i*.022)}px Arial`,Z.textAlign=`center`,Z.textBaseline=`middle`,Z.fillText(e,0,0),Z.restore()}),Z.beginPath(),Z.arc(0,0,s*.88,0,vf),Z.fillStyle=`#173650`,Z.fill(),Z.beginPath(),Z.arc(0,0,i*.075,0,vf),Z.fillStyle=`#d7aa4f`,Z.fill(),Z.restore()}function Pp(){let e=X.profitChart,t=e.getBoundingClientRect(),n=Math.min(window.devicePixelRatio||1,2),r=Math.max(600,t.width||1100);e.width=Math.round(r*n),e.height=Math.round(290*n),xf.setTransform(n,0,0,n,0,0),xf.clearRect(0,0,r,290);let i=Ip(Q.chart,450),a={left:58,right:18,top:18,bottom:34},o=i.flatMap(e=>[e.actual,e.expected,0]),s=Math.min(...o),c=Math.max(...o);s===c&&(--s,c+=1);let l=Math.max(1,i.at(-1)?.x||1),u=e=>a.left+e/l*(r-a.left-a.right),d=e=>a.top+(c-e)/(c-s)*(290-a.top-a.bottom);xf.strokeStyle=`rgba(255,255,255,.10)`,xf.lineWidth=1;for(let e=0;e<=4;e++){let t=a.top+e*(290-a.top-a.bottom)/4;xf.beginPath(),xf.moveTo(a.left,t),xf.lineTo(r-a.right,t),xf.stroke()}xf.beginPath(),xf.moveTo(a.left,d(0)),xf.lineTo(r-a.right,d(0)),xf.strokeStyle=`rgba(255,255,255,.28)`,xf.stroke(),Fp(i,`actual`,`#7aa7ff`,[],2.2,u,d),Fp(i,`expected`,`#ff6b76`,[6,5],1.8,u,d),xf.fillStyle=`rgba(210,222,240,.75)`,xf.font=`12px system-ui`,xf.textAlign=`right`,xf.fillText(Xf(c),a.left-8,a.top+4),xf.fillText(Xf(s),a.left-8,290-a.bottom),xf.textAlign=`center`,xf.fillText(Qf(l),r-a.right,280)}function Fp(e,t,n,r,i,a,o){xf.save(),xf.beginPath(),e.forEach((e,n)=>{let r=a(e.x),i=o(e[t]);n?xf.lineTo(r,i):xf.moveTo(r,i)}),xf.strokeStyle=n,xf.lineWidth=i,xf.setLineDash(r),xf.stroke(),xf.restore()}function Ip(e,t){if(e.length<=t)return e;let n=(e.length-1)/(t-1);return Array.from({length:t},(t,r)=>e[Math.round(r*n)])}function Lp(e){return Math.min(1,Math.max(0,e))}function Rp(e){return(e%vf+vf)%vf}function zp(e,t){let n=Rp(t)-Rp(e);return n>Math.PI&&(n-=vf),n<-Math.PI&&(n+=vf),n}var Bp=[`edge`,`streaks`,`strategies`,`turnover`,`comparison`,`responsible`];function Vp(e,{updateHash:t=!0,focus:n=!1}={}){Pf=Bp.includes(e)?e:`edge`,document.querySelectorAll(`[data-learn-panel]`).forEach(e=>e.classList.toggle(`is-active`,e.dataset.learnPanel===Pf)),document.querySelectorAll(`[data-learn-target]`).forEach(e=>{e.dataset.learnTarget===Pf?e.setAttribute(`aria-current`,`true`):e.removeAttribute(`aria-current`)});let r=Bp.indexOf(Pf);X.learnProgress&&(X.learnProgress.textContent=`${String(r+1).padStart(2,`0`)} / ${String(Bp.length).padStart(2,`0`)}`),X.learnPrev&&(X.learnPrev.disabled=r<=0),X.learnNext&&(X.learnNext.disabled=r>=Bp.length-1),t&&document.body.dataset.view===`learn`&&history.replaceState(null,``,`#learn/${Pf}`);let i=document.querySelector(`[data-learn-target="${Pf}"]`);if(n){let e=document.querySelector(`.app-view[data-view="learn"]`),t=document.querySelector(`.learn-workbench`);if(e&&t){let n=e.scrollTop+t.getBoundingClientRect().top-e.getBoundingClientRect().top;e.scrollTo({top:Math.max(0,n-14),behavior:`auto`})}if(window.innerWidth<=980&&i?.parentElement){let e=i.parentElement;e.scrollTo({left:Math.max(0,i.offsetLeft-(e.clientWidth-i.clientWidth)/2),behavior:`auto`})}}}function Hp(){let[e,t]=location.hash.slice(1).split(`/`),n=em.has(e)?e:`play`;im(n,{updateHash:!1}),n===`learn`&&Vp(t||Pf,{updateHash:!1})}function Up(e,t,n){let r=[];if(e===`martingale`){for(let e=0;e<n;e+=1)r.push(t*2**e);return{bets:r,next:t*2**n}}if(e===`fibonacci`){let e=[1,1];for(;e.length<=n;)e.push(e.at(-1)+e.at(-2));for(let i=0;i<n;i+=1)r.push(t*e[i]);return{bets:r,next:t*e[n]}}if(e===`dalembert`){for(let e=0;e<n;e+=1)r.push(t*(e+1));return{bets:r,next:t*(n+1)}}if(e===`labouchere`){let e=[1,2,3,4];for(let i=0;i<n;i+=1){let n=e.length>1?e[0]+e.at(-1):e[0];r.push(t*n),e.push(n)}return{bets:r,next:t*(e.length>1?e[0]+e.at(-1):e[0])}}for(let e=0;e<n;e+=1)r.push(t);return{bets:r,next:t}}function Wp(){if(!X.strategyName)return;let e=yf[Sf]?.[Ff]||yf.en.flat,t=Number(X.strategyBaseBet?.value||10),n=Number(X.strategyLosses?.value||6),{bets:r,next:i}=Up(Ff,t,n);X.strategyVerdict.textContent=e.verdict,X.strategyName.textContent=e.name,X.strategyDescription.textContent=e.description,X.strategyChanges.textContent=e.changes,X.strategyDoesNotChange.textContent=e.notChanges,X.strategyBaseBetValue.textContent=Xf(t),X.strategyLossesValue.textContent=Qf(n),X.strategyNextBet.textContent=Xf(i),X.strategyBankroll.textContent=Xf(r.reduce((e,t)=>e+t,0)+i),X.strategySequence.innerHTML=``;let a=Math.max(...r,i,1);r.forEach((e,t)=>{let n=document.createElement(`i`);n.style.setProperty(`--h`,`${Math.max(18,e/a*120)}px`),n.textContent=e>999?`${Math.round(e/1e3)}k`:String(Math.round(e)),n.title=`${t+1}: ${Xf(e)}`,X.strategySequence.append(n)}),document.querySelectorAll(`[data-strategy]`).forEach(e=>e.setAttribute(`aria-selected`,String(e.dataset.strategy===Ff)))}function Gp(){if(!X.streakLabResults)return;let e=Array.from({length:20},()=>Yf());X.streakLabResults.innerHTML=``;let t=0,n=0,r=null,i=`red`;e.forEach(e=>{let a=Hf(e),o=document.createElement(`i`);if(o.className=a,o.title=e,X.streakLabResults.append(o),a===`green`){n=0,r=null;return}n=a===r?n+1:1,r=a,n>t&&(t=n,i=a)});let a=Sf===`zh`?`这20次里最长连续同色为 ${t} 次（${i===`red`?`红`:`黑`}）。出现连开并不表示下一次概率改变。`:Sf===`fr`?`La plus longue série dans ces 20 tours est de ${t} (${i===`red`?`rouge`:`noir`}). Une série ne modifie pas le tour suivant.`:`The longest same-colour run in these 20 spins is ${t} (${i}). A streak does not change the next spin.`,o=document.createElement(`p`);o.textContent=a,X.streakLabResults.append(o)}function Kp(){if(!X.turnoverStake)return;let e=Number(X.turnoverStake.value||20),t=Number(X.turnoverSpins.value||100),n=X.turnoverWheel.value===`american`?2/38:1/37,r=e*t,i=r*n,a=Math.max(1,Number(X.startingBankroll?.value||1e3));X.turnoverStakeValue.textContent=Xf(e),X.turnoverSpinsValue.textContent=Qf(t),X.turnoverTotal.textContent=Xf(r),X.turnoverLoss.textContent=Xf(i),X.turnoverBankrollEcho.textContent=Xf(a),X.turnoverTrackFill.style.setProperty(`--w`,`${Math.min(100,Math.max(4,r/a*10))}%`)}function qp(){if(!X.boundarySummary)return;let e=Math.max(1,Number(X.sessionBudget?.value||100)),t=Math.min(e,Math.max(1,Number(X.sessionLossLimit?.value||50))),n=Math.max(5,Number(X.sessionTimeLimit?.value||45));X.sessionLossLimit.max=String(e);let r=Sf===`zh`?`计划：最多使用 ${Xf(e)}，净亏达到 ${Xf(t)} 或经过 ${n} 分钟即停止。`:Sf===`fr`?`Plan : budget maximal ${Xf(e)}; arrêt après ${Xf(t)} de perte nette ou ${n} minutes.`:`Plan: use at most ${Xf(e)} and stop after a ${Xf(t)} net loss or ${n} minutes.`;X.boundarySummary.textContent=r}function Jp(){let e=null,t=0;for(let n of Q.history){let r=Hf(n.result);if(r===`green`||(e===null&&(e=r),r!==e))break;t+=1}return{color:e,count:t}}function Yp(e,{force:t=!1}={}){let n=bf[Sf]?.[e];!n||!X.behaviorCoach||!t&&If.kind===e&&Q.spins-If.lastShownSpin<3||(If={kind:e,topic:n.topic,hidden:!1,lastShownSpin:Q.spins},X.coachTitle.textContent=n.title,X.coachBody.textContent=n.body,X.behaviorCoach.hidden=!1)}function Xp(){X.behaviorCoach&&(If.hidden=!0,X.behaviorCoach.hidden=!0)}function Zp(){if(If.hidden||!If.kind)return;let e=bf[Sf]?.[If.kind];e&&(X.coachTitle.textContent=e.title,X.coachBody.textContent=e.body)}function Qp(e){let t=Jp();if(t.count>=3&&(e===`red`||e===`black`)){Yp(e===t.color?`hot`:`due`);return}let n=Q.history[0];if(n?.net<0&&Gf()>=Math.max(Cf*2,n.stake*1.8)){Yp(`martingale`);return}Of.has(Uf(`red`))&&Of.has(Uf(`black`))&&Yp(`hedge`)}function $p(e){Jp().count>=4?Yp(`hot`):X.wheelType.value===`american`&&Q.spins<=2?Yp(`doublezero`):Q.wagered>=Q.startingBankroll*4&&Q.spins%4==0?Yp(`turnover`):e.net>0&&Q.spins<=5&&Yp(`variance`)}var em=new Set([`play`,`rules`,`learn`]),tm=0;function nm(e){let t=new Set([`board`,`slip`,`stats`]).has(e)?e:`board`;document.querySelectorAll(`[data-inspector]`).forEach(e=>e.classList.toggle(`is-active`,e.dataset.inspector===t)),document.querySelectorAll(`[data-inspector-target]`).forEach(e=>e.setAttribute(`aria-selected`,String(e.dataset.inspectorTarget===t))),t===`stats`&&requestAnimationFrame(Pp)}function rm(e){let t=[...document.querySelectorAll(`[data-tutorial]`)];t.length&&(tm=Math.max(0,Math.min(t.length-1,Number(e)||0)),t.forEach((e,t)=>e.classList.toggle(`is-active`,t===tm)),document.querySelectorAll(`[data-tutorial-target]`).forEach((e,t)=>{t===tm?e.setAttribute(`aria-current`,`step`):e.removeAttribute(`aria-current`)}),document.querySelectorAll(`.lesson-dots i`).forEach((e,t)=>e.classList.toggle(`active`,t===tm)),X.lessonPrev&&(X.lessonPrev.disabled=tm===0),X.lessonNext&&(X.lessonNext.disabled=tm===t.length-1))}function im(e,{updateHash:t=!0}={}){let n=em.has(e)?e:`play`;document.body.dataset.view=n,document.querySelectorAll(`.app-view`).forEach(e=>e.classList.toggle(`is-active`,e.dataset.view===n)),document.querySelectorAll(`.top-tabs [data-view-target], .bottom-tabs [data-view-target]`).forEach(e=>e.setAttribute(`aria-selected`,String(e.dataset.viewTarget===n)));let r=n===`learn`?`#learn/${Pf}`:`#${n}`;t&&location.hash!==r&&history.replaceState(null,``,r);let i=document.querySelector(`.app-view[data-view="${n}"]`);i&&(i.scrollTop=0),n===`play`?(ip(),requestAnimationFrame(()=>window.dispatchEvent(new Event(`resize`)))):(op(),Ef&&wp({showMenu:!1}),Mf?.setSound(!1),Mf?.setAmbience(!1))}document.querySelectorAll(`[data-view-target]`).forEach(e=>e.addEventListener(`click`,()=>im(e.dataset.viewTarget))),document.querySelectorAll(`[data-inspector-target]`).forEach(e=>e.addEventListener(`click`,()=>nm(e.dataset.inspectorTarget))),document.querySelectorAll(`[data-tutorial-target]`).forEach(e=>e.addEventListener(`click`,()=>rm(e.dataset.tutorialTarget))),X.lessonPrev?.addEventListener(`click`,()=>rm(tm-1)),X.lessonNext?.addEventListener(`click`,()=>rm(tm+1)),window.addEventListener(`hashchange`,Hp),document.querySelectorAll(`[data-learn-target]`).forEach(e=>e.addEventListener(`click`,()=>Vp(e.dataset.learnTarget,{focus:!0}))),document.querySelectorAll(`[data-strategy]`).forEach(e=>e.addEventListener(`click`,()=>{Ff=e.dataset.strategy,Wp()})),X.learnPrev?.addEventListener(`click`,()=>Vp(Bp[Math.max(0,Bp.indexOf(Pf)-1)],{focus:!0})),X.learnNext?.addEventListener(`click`,()=>Vp(Bp[Math.min(Bp.length-1,Bp.indexOf(Pf)+1)],{focus:!0})),X.strategyBaseBet?.addEventListener(`input`,Wp),X.strategyLosses?.addEventListener(`input`,Wp),X.streakLabRun?.addEventListener(`click`,Gp),[X.turnoverStake,X.turnoverSpins,X.turnoverWheel].forEach(e=>e?.addEventListener(`input`,Kp)),[X.sessionBudget,X.sessionLossLimit,X.sessionTimeLimit].forEach(e=>e?.addEventListener(`input`,qp)),X.coachDismissButton?.addEventListener(`click`,Xp),X.coachLearnButton?.addEventListener(`click`,()=>{im(`learn`),Vp(If.topic||`streaks`,{focus:!0})}),X.languageSelect.value=Sf,X.languageSelect.addEventListener(`change`,e=>{Sf=e.target.value,cp()}),document.querySelectorAll(`[data-chip]`).forEach(e=>{e.addEventListener(`click`,()=>{Cf=Number(e.dataset.chip),document.querySelectorAll(`[data-chip]`).forEach(t=>t.classList.toggle(`is-active`,t===e)),gp()})}),X.undoBetButton.addEventListener(`click`,fp),X.clearBetsButton.addEventListener(`click`,mp),X.repeatBetsButton.addEventListener(`click`,hp),X.pauseButton.addEventListener(`click`,()=>wp()),X.batchButton.addEventListener(`click`,Ep),X.resetButton.addEventListener(`click`,()=>Dp(!0)),X.resetButtonSecondary.addEventListener(`click`,()=>Dp(!0)),X.soundToggle.addEventListener(`change`,()=>{Rf.sfx=X.soundToggle.checked,ip({unlock:!0})}),X.pauseSfxToggle?.addEventListener(`change`,()=>{Rf.sfx=X.pauseSfxToggle.checked,ip({unlock:!0})}),X.ambienceToggle?.addEventListener(`change`,()=>{Rf.ambience=X.ambienceToggle.checked,ip({unlock:!0})}),X.masterVolume?.addEventListener(`input`,()=>{Rf.volume=Number(X.masterVolume.value)/100,ip({unlock:!0})}),X.cameraResetButton?.addEventListener(`click`,sp),X.pauseCameraResetButton?.addEventListener(`click`,sp),X.pauseCloseButton?.addEventListener(`click`,op),X.resumeButton?.addEventListener(`click`,()=>{Ef?op():wp({showMenu:!1})}),X.resetSessionButton?.addEventListener(`click`,()=>{Dp(!0),ap({focus:!1})}),X.pauseOverlay?.addEventListener(`click`,e=>{e.target===X.pauseOverlay&&op()}),window.addEventListener(`keydown`,e=>{e.key===`Escape`&&Lf&&op()}),X.startingBankroll.addEventListener(`change`,()=>{!Tf&&Q.spins===0&&Dp(!1)}),X.wheelType.addEventListener(`change`,()=>{if(Tf||Ef){tp($(`wheelChangePaused`));return}Of.clear(),kf=[],jf=[],Mf?.setOrder(Bf()),up(),gp(),Np(),Mp(),X.wheelType.value===`american`&&Yp(`doublezero`,{force:!0})}),window.addEventListener(`resize`,()=>{Np(),Pp()}),Mf=new ff(X.roulette3D,{order:Bf(),onPocketClick:e=>dp(`straight`,String(e))}),await Mf.init(),rp(),ip();var am=()=>{ip({unlock:!0})};window.addEventListener(`pointerdown`,am,{once:!0,passive:!0}),window.addEventListener(`keydown`,am,{once:!0}),cp(),nm(`board`),rm(0),vp(`idle`),Op(),Cp(),Vp(Pf,{updateHash:!1}),Wp(),Kp(),qp(),Hp(),window.__rouletteLab={getState:()=>structuredClone(Q),getBets:()=>Wf([...Of.values()]),placeBet:dp,undoBet:fp,clearBets:mp,toggleAuto:wp,resetCamera:sp,scene:()=>Mf};